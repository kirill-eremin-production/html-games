  ...
  if (dayPhase === "summary") {
    return (
      <div className="relative flex flex-1 flex-col overflow-hidden">
        <ShopBackground src={shopBg} />
        <div className="relative z-[2] flex flex-1 flex-col items-center justify-center gap-2 p-4">
    ...
    <div className="relative flex flex-1 flex-col overflow-hidden">
      ...
      {cust ? (
        <>
          ...
          <div className="relative z-[2] flex flex-1 flex-col overflow-hidden">
            {/* Scan phase — items laid on counter */}
            {cust.phase === "scan" && (
              <div className="flex-1 overflow-auto px-2 pt-3 pb-1">
            ...
            {/* Change phase */}
            {cust.phase === "change" && (
              <div className="flex flex-1 flex-col gap-1.5 overflow-auto px-2 pt-3 pb-1">
                <div
        ...
        /* ── No customer — empty shop ── */
        <div className="relative z-[2] flex flex-1 flex-col items-center justify-center gap-1.5 p-3">
