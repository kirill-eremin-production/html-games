...
export function setGalaxyBrightness(value: number): void {
  ...
  if (refs.mainStarsMat) refs.mainStarsMat.setFloat('opacity', BASE_MAIN_OPACITY * value);
  if (refs.brightStarsMat) refs.brightStarsMat.setFloat('opacity', BASE_BRIGHT_OPACITY * value);
