import{S as e}from"./index-Co_ZLgYR.js";import"./oitFragment-xClrtTVJ.js";const i="bumpFragmentMainFunctions",r=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=r);const t="bumpFragmentFunctions",f=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=f);const a="bumpFragment",s=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=s);const n="decalFragment",d=`#ifdef DECAL
...
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=d);const o="lightFragment",l=`#ifdef LIGHT{X}
