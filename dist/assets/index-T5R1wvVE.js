...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:pi,depthTest:!1,depthWrite:!1})}function Od(){return new jn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Vo(),fragmentShader:`
		...
		`,blending:pi,depthTest:!1,depthWrite:!1})}function Bd(){return new jn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Vo(),fragmentShader:`
	...
	`}class Wp extends Yn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const n={width:e,height:e,depth:1},s=[n,n,n,n,n,n];this.texture=new Up(s),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},s=new ra(5,5,5),r=new jn({name:"CubemapFromEquirect",uniforms:nr(n.uniforms),vertexShader:n.vertexShader,fragmentShader:n.fragmentShader,side:an,blending:pi});r.uniforms.tEquirect.value=t;const a=new Mt(s,r),o=t.minFilter;return t.minFilter===ui&&(t.minFilter=wt),new X_(1,10,this).update(e,a),t.minFilter=o,a.geometry.dispose(),a.material.dispose(),this}clear(e,t=!0,n=!0,s=!0){const r=e.getRenderTarget();for(let a=0;a<6;a++)e.setRenderTarget(this,a),e.clear(t,n,s);e.setRenderTarget(r)}}function jy(i){let e=new WeakMap,t=new WeakMap,n=null;function s(d,f=!1){return d==null?null:f?a(d):r(d)}function r(d){if(d&&d.isTexture){const f=d.mapping;if(f===Jo||f===Qo)if(e.has(d)){const g=e.get(d).texture;return o(g,d.mapping)}else{const g=d.image;if(g&&g.height>0){const x=new Wp(g.height);return x.fromEquirectangularTexture(i,d),e.set(d,x),d.addEventListener("dispose",c),o(x.texture,d.mapping)}else return null}}return d}function a(d){if(d&&d.isTexture){const f=d.mapping,g=f===Jo||f===Qo,x=f===ps||f===Js;if(g||x){let m=t.get(d);const p=m!==void 0?m.texture.pmremVersion:0;if(d.isRenderTargetTexture&&d.pmremVersion!==p)return n===null&&(n=new Ud(i)),m=g?n.fromEquirectangular(d,m):n.fromCubemap(d,m),m.texture.pmremVersion=d.pmremVersion,t.set(d,m),m.texture;if(m!==void 0)return m.texture;{const y=d.image;return g&&y&&y.height>0||x&&y&&l(y)?(n===null&&(n=new Ud(i)),m=g?n.fromEquirectangular(d):n.fromCubemap(d),m.texture.pmremVersion=d.pmremVersion,t.set(d,m),d.addEventListener("dispose",h),m.texture):null}}}return d}function o(d,f){return f===Jo?d.mapping=ps:f===Qo&&(d.mapping=Js),d}function l(d){let f=0;const g=6;for(let x=0;x<g;x++)d[x]!==void 0&&f++;return f===g}function c(d){const f=d.target;f.removeEventListener("dispose",c);const g=e.get(f);g!==void 0&&(e.delete(f),g.dispose())}function h(d){const f=d.target;f.removeEventListener("dispose",h);const g=t.get(f);g!==void 0&&(t.delete(f),g.dispose())}function u(){e=new WeakMap,t=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:s,dispose:u}}function Zy(i){const e={};function t(n){if(e[n]!==void 0)return e[n];const s=i.getExtension(n);return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const s=t(n);return s===null&&go("WebGLRenderer: "+n+" extension not supported."),s}}}function Jy(i,e,t,n){const s={},r=new WeakMap;function a(u){const d=u.target;d.index!==null&&e.remove(d.index);for(const g in d.attributes)e.remove(d.attributes[g]);d.removeEventListener("dispose",a),delete s[d.id];const f=r.get(d);f&&(e.remove(f),r.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function o(u,d){return s[d.id]===!0||(d.addEventListener("dispose",a),s[d.id]=!0,t.memory.geometries++),d}function l(u){const d=u.attributes;for(const f in d)e.update(d[f],i.ARRAY_BUFFER)}function c(u){const d=[],f=u.index,g=u.attributes.position;let x=0;if(g===void 0)return;if(f!==null){const y=f.array;x=f.version;for(let S=0,M=y.length;S<M;S+=3){const T=y[S+0],A=y[S+1],C=y[S+2];d.push(T,A,A,C,C,T)}}else{const y=g.array;x=g.version;for(let S=0,M=y.length/3-1;S<M;S+=3){const T=S+0,A=S+1,C=S+2;d.push(T,A,A,C,C,T)}}const m=new(g.count>=65535?Pp:Ip)(d,1);m.version=x;const p=r.get(u);p&&e.remove(p),r.set(u,m)}function h(u){const d=r.get(u);if(d){const f=u.index;f!==null&&d.version<f.version&&c(u)}else c(u);return r.get(u)}return{get:o,update:l,getWireframeAttribute:h}}function Qy(i,e,t){let n;function s(d){n=d}let r,a;function o(d){r=d.type,a=d.bytesPerElement}function l(d,f){i.drawElements(n,f,r,d*a),t.update(f,n,1)}function c(d,f,g){g!==0&&(i.drawElementsInstanced(n,f,r,d*a,g),t.update(f,n,g))}function h(d,f,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,f,0,r,d,0,g);let m=0;for(let p=0;p<g;p++)m+=f[p];t.update(m,n,1)}function u(d,f,g,x){if(g===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let p=0;p<d.length;p++)c(d[p]/a,f[p],x[p]);else{m.multiDrawElementsInstancedWEBGL(n,f,0,r,d,0,x,0,g);let p=0;for(let y=0;y<g;y++)p+=f[y]*x[y];t.update(p,n,1)}}this.setMode=s,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function eM(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(r/3);break;case i.LINES:t.lines+=o*(r/2);break;case i.LINE_STRIP:t.lines+=o*(r-1);break;case i.LINE_LOOP:t.lines+=o*r;break;case i.POINTS:t.points+=o*r;break;default:Ue("WebGLInfo: Unknown draw mode:",a);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function tM(i,e,t){const n=new WeakMap,s=new yt;function r(a,o,l){const c=a.morphTargetInfluences,h=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,u=h!==void 0?h.length:0;let d=n.get(o);if(d===void 0||d.count!==u){let B=function(){_.dispose(),n.delete(o),o.removeEventListener("dispose",B)};var f=B;d!==void 0&&d.texture.dispose();const g=o.morphAttributes.position!==void 0,x=o.morphAttributes.normal!==void 0,m=o.morphAttributes.color!==void 0,p=o.morphAttributes.position||[],y=o.morphAttributes.normal||[],S=o.morphAttributes.color||[];let M=0;g===!0&&(M=1),x===!0&&(M=2),m===!0&&(M=3);let T=o.attributes.position.count*M,A=1;T>e.maxTextureSize&&(A=Math.ceil(T/e.maxTextureSize),T=e.maxTextureSize);const C=new Float32Array(T*A*4*u),_=new wp(C,T,A,u);_.type=vn,_.needsUpdate=!0;const E=M*4;for(let I=0;I<u;I++){const O=p[I],k=y[I],X=S[I],z=T*A*4*I;for(let G=0;G<O.count;G++){const L=G*E;g===!0&&(s.fromBufferAttribute(O,G),C[z+L+0]=s.x,C[z+L+1]=s.y,C[z+L+2]=s.z,C[z+L+3]=0),x===!0&&(s.fromBufferAttribute(k,G),C[z+L+4]=s.x,C[z+L+5]=s.y,C[z+L+6]=s.z,C[z+L+7]=0),m===!0&&(s.fromBufferAttribute(X,G),C[z+L+8]=s.x,C[z+L+9]=s.y,C[z+L+10]=s.z,C[z+L+11]=X.itemSize===4?s.w:1)}}d={count:u,texture:_,size:new Be(T,A)},n.set(o,d),o.addEventListener("dispose",B)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let g=0;for(let m=0;m<c.length;m++)g+=c[m];const x=o.morphTargetsRelative?1:1-g;l.getUniforms().setValue(i,"morphTargetBaseInfluence",x),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",d.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",d.size)}return{update:r}}function nM(i,e,t,n,s){let r=new WeakMap;function a(c){const h=s.render.frame,u=c.geometry,d=e.get(c,u);if(r.get(d)!==h&&(e.update(d),r.set(d,h)),c.isInstancedMesh&&(c.hasEventListener("dispose",l)===!1&&c.addEventListener("dispose",l),r.get(c)!==h&&(t.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,i.ARRAY_BUFFER),r.set(c,h))),c.isSkinnedMesh){const f=c.skeleton;r.get(f)!==h&&(f.update(),r.set(f,h))}return d}function o(){r=new WeakMap}function l(c){const h=c.target;h.removeEventListener("dispose",l),n.releaseStatesOfObject(h),t.remove(h.instanceMatrix),h.instanceColor!==null&&t.remove(h.instanceColor)}return{update:a,dispose:o}}const iM={[up]:"LINEAR_TONE_MAPPING",[hp]:"REINHARD_TONE_MAPPING",[dp]:"CINEON_TONE_MAPPING",[fp]:"ACES_FILMIC_TONE_MAPPING",[mp]:"AGX_TONE_MAPPING",[gp]:"NEUTRAL_TONE_MAPPING",[pp]:"CUSTOM_TONE_MAPPING"};function sM(i,e,t,n,s){const r=new Yn(e,t,{type:i,depthBuffer:n,stencilBuffer:s}),a=new Yn(e,t,{type:xi,depthBuffer:!1,stencilBuffer:!1}),o=new Lt;o.setAttribute("position",new bt([-1,3,0,-1,-1,0,3,-1,0],3)),o.setAttribute("uv",new bt([0,2,0,0,2,0],2));const l=new S_({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),c=new Mt(o,l),h=new ko(-1,1,1,-1,0,1);let u=null,d=null,f=!1,g,x=null,m=[],p=!1;this.setSize=function(y,S){r.setSize(y,S),a.setSize(y,S);for(let M=0;M<m.length;M++){const T=m[M];T.setSize&&T.setSize(y,S)}},this.setEffects=function(y){m=y,p=m.length>0&&m[0].isRenderPass===!0;const S=r.width,M=r.height;for(let T=0;T<m.length;T++){const A=m[T];A.setSize&&A.setSize(S,M)}},this.begin=function(y,S){if(f||y.toneMapping===qn&&m.length===0)return!1;if(x=S,S!==null){const M=S.width,T=S.height;(r.width!==M||r.height!==T)&&this.setSize(M,T)}return p===!1&&y.setRenderTarget(r),g=y.toneMapping,y.toneMapping=qn,!0},this.hasRenderPass=function(){return p},this.end=function(y,S){y.toneMapping=g,f=!0;let M=r,T=a;for(let A=0;A<m.length;A++){const C=m[A];if(C.enabled!==!1&&(C.render(y,T,M,S),C.needsSwap!==!1)){const _=M;M=T,T=_}}if(u!==y.outputColorSpace||d!==y.toneMapping){u=y.outputColorSpace,d=y.toneMapping,l.defines={},Qe.getTransfer(u)===rt&&(l.defines.SRGB_TRANSFER="");const A=iM[d];A&&(l.defines[A]=""),l.needsUpdate=!0}l.uniforms.tDiffuse.value=M.texture,y.setRenderTarget(x),y.render(c,h),x=null,f=!1},this.isCompositing=function(){return f},this.dispose=function(){r.dispose(),a.dispose(),o.dispose(),l.dispose()}}const Xp=new Ot,au=new Zr(1,1),qp=new wp,Yp=new K0,Kp=new Up,kd=[],zd=[],Hd=new Float32Array(16),Vd=new Float32Array(9),Gd=new Float32Array(4);function gr(i,e,t){const n=i[0];if(n<=0||n>0)return i;const s=e*t;let r=kd[s];if(r===void 0&&(r=new Float32Array(s),kd[s]=r),e!==0){n.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(r,o)}return r}function Bt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function kt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function Go(i,e){let t=zd[e];t===void 0&&(t=new Int32Array(e),zd[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function rM(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function aM(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Bt(t,e))return;i.uniform2fv(this.addr,e),kt(t,e)}}function oM(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Bt(t,e))return;i.uniform3fv(this.addr,e),kt(t,e)}}function lM(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Bt(t,e))return;i.uniform4fv(this.addr,e),kt(t,e)}}function cM(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Bt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),kt(t,e)}else{if(Bt(t,n))return;Gd.set(n),i.uniformMatrix2fv(this.addr,!1,Gd),kt(t,n)}}function uM(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Bt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),kt(t,e)}else{if(Bt(t,n))return;Vd.set(n),i.uniformMatrix3fv(this.addr,!1,Vd),kt(t,n)}}function hM(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Bt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),kt(t,e)}else{if(Bt(t,n))return;Hd.set(n),i.uniformMatrix4fv(this.addr,!1,Hd),kt(t,n)}}function dM(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function fM(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Bt(t,e))return;i.uniform2iv(this.addr,e),kt(t,e)}}function pM(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Bt(t,e))return;i.uniform3iv(this.addr,e),kt(t,e)}}function mM(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Bt(t,e))return;i.uniform4iv(this.addr,e),kt(t,e)}}function gM(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function _M(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Bt(t,e))return;i.uniform2uiv(this.addr,e),kt(t,e)}}function xM(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Bt(t,e))return;i.uniform3uiv(this.addr,e),kt(t,e)}}function vM(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Bt(t,e))return;i.uniform4uiv(this.addr,e),kt(t,e)}}function yM(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(au.compareFunction=t.isReversedDepthBuffer()?qu:Xu,r=au):r=Xp,t.setTexture2D(e||r,s)}function MM(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture3D(e||Yp,s)}function SM(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTextureCube(e||Kp,s)}function bM(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture2DArray(e||qp,s)}function EM(i){switch(i){case 5126:return rM;case 35664:return aM;case 35665:return oM;case 35666:return lM;case 35674:return cM;case 35675:return uM;case 35676:return hM;case 5124:case 35670:return dM;case 35667:case 35671:return fM;case 35668:case 35672:return pM;case 35669:case 35673:return mM;case 5125:return gM;case 36294:return _M;case 36295:return xM;case 36296:return vM;case 35678:case 36198:case 36298:case 36306:case 35682:return yM;case 35679:case 36299:case 36307:return MM;case 35680:case 36300:case 36308:case 36293:return SM;case 36289:case 36303:case 36311:case 36292:return bM}}function TM(i,e){i.uniform1fv(this.addr,e)}function AM(i,e){const t=gr(e,this.size,2);i.uniform2fv(this.addr,t)}function wM(i,e){const t=gr(e,this.size,3);i.uniform3fv(this.addr,t)}function RM(i,e){const t=gr(e,this.size,4);i.uniform4fv(this.addr,t)}function CM(i,e){const t=gr(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function IM(i,e){const t=gr(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function PM(i,e){const t=gr(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function LM(i,e){i.uniform1iv(this.addr,e)}function DM(i,e){i.uniform2iv(this.addr,e)}function NM(i,e){i.uniform3iv(this.addr,e)}function UM(i,e){i.uniform4iv(this.addr,e)}function FM(i,e){i.uniform1uiv(this.addr,e)}function OM(i,e){i.uniform2uiv(this.addr,e)}function BM(i,e){i.uniform3uiv(this.addr,e)}function kM(i,e){i.uniform4uiv(this.addr,e)}function zM(i,e,t){const n=this.cache,s=e.length,r=Go(t,s);Bt(n,r)||(i.uniform1iv(this.addr,r),kt(n,r));let a;this.type===i.SAMPLER_2D_SHADOW?a=au:a=Xp;for(let o=0;o!==s;++o)t.setTexture2D(e[o]||a,r[o])}function HM(i,e,t){const n=this.cache,s=e.length,r=Go(t,s);Bt(n,r)||(i.uniform1iv(this.addr,r),kt(n,r));for(let a=0;a!==s;++a)t.setTexture3D(e[a]||Yp,r[a])}function VM(i,e,t){const n=this.cache,s=e.length,r=Go(t,s);Bt(n,r)||(i.uniform1iv(this.addr,r),kt(n,r));for(let a=0;a!==s;++a)t.setTextureCube(e[a]||Kp,r[a])}function GM(i,e,t){const n=this.cache,s=e.length,r=Go(t,s);Bt(n,r)||(i.uniform1iv(this.addr,r),kt(n,r));for(let a=0;a!==s;++a)t.setTexture2DArray(e[a]||qp,r[a])}function WM(i){switch(i){case 5126:return TM;case 35664:return AM;case 35665:return wM;case 35666:return RM;case 35674:return CM;case 35675:return IM;case 35676:return PM;case 5124:case 35670:return LM;case 35667:case 35671:return DM;case 35668:case 35672:return NM;case 35669:case 35673:return UM;case 5125:return FM;case 36294:return OM;case 36295:return BM;case 36296:return kM;case 35678:case 36198:case 36298:case 36306:case 35682:return zM;case 35679:case 36299:case 36307:return HM;case 35680:case 36300:case 36308:case 36293:return VM;case 36289:case 36303:case 36311:case 36292:return GM}}class XM{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=EM(t.type)}}class qM{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=WM(t.type)}}class YM{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const s=this.seq;for(let r=0,a=s.length;r!==a;++r){const o=s[r];o.setValue(e,t[o.id],n)}}}const Dl=/(\w+)(\])?(\[|\.)?/g;function Wd(i,e){i.seq.push(e),i.map[e.id]=e}function KM(i,e,t){const n=i.name,s=n.length;for(Dl.lastIndex=0;;){const r=Dl.exec(n),a=Dl.lastIndex;let o=r[1];const l=r[2]==="]",c=r[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===s){Wd(t,c===void 0?new XM(o,i,e):new qM(o,i,e));break}else{let u=t.map[o];u===void 0&&(u=new YM(o),Wd(t,u)),t=u}}}class ao{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let a=0;a<n;++a){const o=e.getActiveUniform(t,a),l=e.getUniformLocation(t,o.name);KM(o,l,this)}const s=[],r=[];for(const a of this.seq)a.type===e.SAMPLER_2D_SHADOW||a.type===e.SAMPLER_CUBE_SHADOW||a.type===e.SAMPLER_2D_ARRAY_SHADOW?s.push(a):r.push(a);s.length>0&&(this.seq=s.concat(r))}setValue(e,t,n,s){const r=this.map[t];r!==void 0&&r.setValue(e,n,s)}setOptional(e,t,n){const s=t[n];s!==void 0&&this.setValue(e,n,s)}static upload(e,t,n,s){for(let r=0,a=t.length;r!==a;++r){const o=t[r],l=n[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,s)}}static seqWithValue(e,t){const n=[];for(let s=0,r=e.length;s!==r;++s){const a=e[s];a.id in t&&n.push(a)}return n}}function Xd(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const $M=37297;let jM=0;function ZM(i,e){const t=i.split(`
`),n=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=s;a<r;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}const qd=new Ve;function JM(i){Qe._getMatrix(qd,Qe.workingColorSpace,i);const e=`mat3( ${qd.elements.map(t=>t.toFixed(4))} )`;switch(Qe.getTransfer(i)){case po:return[e,"LinearTransferOETF"];case rt:return[e,"sRGBTransferOETF"];default:return Ce("WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function Yd(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=(i.getShaderInfoLog(e)||"").trim();if(n&&r==="")return"";const a=/ERROR: 0:(\d+)/.exec(r);if(a){const o=parseInt(a[1]);return t.toUpperCase()+`

`+r+`

`+ZM(i.getShaderSource(e),o)}else return r}function QM(i,e){const t=JM(e);return[`vec4 ${i}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}const eS={[up]:"Linear",[hp]:"Reinhard",[dp]:"Cineon",[fp]:"ACESFilmic",[mp]:"AgX",[gp]:"Neutral",[pp]:"Custom"};function tS(i,e){const t=eS[e];return t===void 0?(Ce("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Xa=new P;function nS(){Qe.getLuminanceCoefficients(Xa);const i=Xa.x.toFixed(4),e=Xa.y.toFixed(4),t=Xa.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function iS(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Ur).join(`
`)}function sS(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function rS(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(e,s),a=r.name;let o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function Ur(i){return i!==""}function Kd(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function $d(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const aS=/^[ \t]*#include +<([\w\d./]+)>/gm;function ou(i){return i.replace(aS,lS)}const oS=new Map;function lS(i,e){let t=Ge[e];if(t===void 0){const n=oS.get(e);if(n!==void 0)t=Ge[n],Ce('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return ou(t)}const cS=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function jd(i){return i.replace(cS,uS)}function uS(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Zd(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}const hS={[eo]:"SHADOWMAP_TYPE_PCF",[Dr]:"SHADOWMAP_TYPE_VSM"};function dS(i){return hS[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const fS={[ps]:"ENVMAP_TYPE_CUBE",[Js]:"ENVMAP_TYPE_CUBE",[Uo]:"ENVMAP_TYPE_CUBE_UV"};function pS(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":fS[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const mS={[Js]:"ENVMAP_MODE_REFRACTION"};function gS(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":mS[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const _S={[Fu]:"ENVMAP_BLENDING_MULTIPLY",[l0]:"ENVMAP_BLENDING_MIX",[c0]:"ENVMAP_BLENDING_ADD"};function xS(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":_S[i.combine]||"ENVMAP_BLENDING_NONE"}function vS(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function yS(i,e,t,n){const s=i.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=dS(t),c=pS(t),h=gS(t),u=xS(t),d=vS(t),f=iS(t),g=sS(r),x=s.createProgram();let m,p,y=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
    ...
    <button class="station-btn result-continue-btn" id="result-continue-btn">ПРОДОЛЖИТЬ</button>`,t}},Cm="space-combat-campaign";let gs=!1;const ae={money:fh,fuel:ph,maxFuel:mh,currentSystemId:"solaris",activeContract:null,completedContracts:0,lastCombatScore:0};let co=[];function oT(i){gs=i}function lT(){gs=!0,ae.money=fh,ae.fuel=ph,ae.maxFuel=mh,ae.currentSystemId="solaris",ae.activeContract=null,ae.completedContracts=0,ae.lastCombatScore=0,ua(),Vi()}function ua(){const i=XE(ae.currentSystemId);let e=ae.completedContracts;co=i.map(t=>{const n=rT[t.difficulty];return e++,{id:`contract-${e}`,difficulty:t.difficulty,title:t.title,description:t.description,targetSystemId:t.targetSystemId,reward:n.base,scoreMultiplier:n.scoreMultiplier}})}function cT(i){ae.activeContract=i,Vi()}function uT(i,e){if(ae.lastCombatScore=e,!ae.activeContract)return 0;const t=ae.activeContract;let n;return i?n=t.reward+Math.floor(e*t.scoreMultiplier/100):n=Math.floor(t.reward*.3),ae.money+=n,ae.activeContract=null,ae.completedContracts++,Vi(),n}function hT(){ae.activeContract=null;const i=Math.min(iT,ae.money);return ae.money-=i,Vi(),i}function dT(i){const e=ae.maxFuel-ae.fuel,t=Math.min(i,e),n=t*50;return t<=0||ae.money<n?!1:(ae.money-=n,ae.fuel+=t,Vi(),!0)}function fT(i){return ae.fuel<i?!1:(ae.fuel-=i,Vi(),!0)}function pT(i){ae.currentSystemId=i,Vi()}function mT(){return ae.fuel===0&&ae.money<50}function gT(){ae.fuel=1,Vi()}function Vi(){try{localStorage.setItem(Cm,JSON.stringify({money:ae.money,fuel:ae.fuel,maxFuel:ae.maxFuel,currentSystemId:ae.currentSystemId,activeContract:ae.activeContract,completedContracts:ae.completedContracts,lastCombatScore:ae.lastCombatScore}))}catch{}}function _T(){try{const i=localStorage.getItem(Cm);if(!i)return!1;const e=JSON.parse(i);return ae.money=e.money??fh,ae.fuel=e.fuel??ph,ae.maxFuel=e.maxFuel??mh,ae.currentSystemId=e.currentSystemId??"solaris",ae.activeContract=e.activeContract??null,ae.completedContracts=e.completedContracts??0,ae.lastCombatScore=e.lastCombatScore??0,jt(ae.currentSystemId)||(ae.currentSystemId="solaris"),!0}catch{return!1}}let Xn=null,Eo=null;function Im(){const i=document.getElementById("result-continue-btn");i&&i.addEventListener("click",()=>{Eo&&Eo()})}function xT(i,e,t){if(Xn=document.getElementById("combat-result"),!Xn)return;Eo=t;const n=uT(i,e);Xn.innerHTML=Rm.victory({victory:i,combatScore:e,reward:n,money:ae.money}),Xn.style.display="flex",Im()}function vT(i,e){Xn=document.getElementById("combat-result"),Xn&&(Eo=e,Xn.innerHTML=Rm.desertion(i,ae.money),Xn.style.display="flex",Im())}function ha(){Xn&&(Xn.style.display="none")}let mu=null,ta=null;function yT(i,e){mu=i,ta=e}function $o(){const i=["start-screen","game-over","victory-screen","pause-screen"];for(const e of i){const t=document.getElementById(e);t&&(t.style.display="none")}}function MT(){_T()?(oT(!0),ua()):lT(),gh()}function gh(i=!0){$o(),ha(),Ko(),la(),qo(),Si("galaxy",{resetCamera:i,onStation:()=>_h(),onCombat:()=>bT(),onExploration:()=>ST()})}function _h(){$o(),Si("station",{onBack:()=>gh(!1)})}function ST(){$o(),ha(),Si("exploration",{systemId:ae.currentSystemId,exitCallback:()=>Pm()})}function Pm(){gh(!1)}function bT(){if(!ae.activeContract)return;const i=ae.activeContract.difficulty,e=sT[i];$o(),ha(),ym(),Mm(ae.currentSystemId),Sm(),Yo(!0),vt.explorationTime=0,mu&&mu(e)}function Lm(i,e){gs&&(ta&&ta(),Ko(),la(),qo(),Si("result"),xT(i,e,()=>{ha(),ua(),_h()}))}function ET(){if(!gs)return;ta&&ta(),Ko(),la(),qo(),Si("result");const i=hT();vT(i,()=>{ha(),ua(),_h()})}const Dm={minimap:{size:180,center:90,scale:.025,playerDotRadius:4,dotRadius:2,dirLineLength:15,capitalShipMarkerSize:4,borderRadius:88,padding:3},damageEffect:{flashGlowSize:80,lowHealthThreshold:30,lowHealthPulseSpeed:.01,lowHealthGlowSize:30,lowHealthGlowOpacity:.3}},TT={retargetChance:.01,enemyTargetPlayerChance:.5,allyTargetCapitalChance:.005,evadeDistance:100,chaseDistance:500,orbitDistance:250,evadeTimerBase:2,evadeTimerRange:2,chaseTimer:3,orbitTimerBase:3,orbitTimerRange:3,evadeNoiseXZ:.8,evadeNoiseY:.4,orbitYNoise:.3,orbitCorrection:.3,turnRate:1.5,rollRate:1.5,shootDistance:400,shootTimerBase:.5,shootTimerRange:.7,exhaustPulseSpeed:.006,exhaustPulsePhaseMultiplier:1.7,exhaustOpacityBase:.6,exhaustOpacityRange:.3,exhaustScaleBase:.9,exhaustScaleRange:.2};function To(i){i.traverse(e=>{if(e.isMesh){const t=e;t.geometry.dispose();const n=Array.isArray(t.material)?t.material:[t.material];for(const s of n)s.dispose()}}),i.parent?.remove(i)}const dt=TT,jl=new P,Of=new P,Lr=new P,Bf=new fn,kf=new fn,zf=new P,AT=new P,Hf=new P,Vf=new P;let Zl=null;function wT(i,e){Zl=null;let t=1/0;for(const n of e){const s=i.distanceToSquared(n.mesh.position);s<t&&(t=s,Zl=n)}return Zl}function Nm(i,e,t,n,s,r,a){if((!i.ai.target||Math.random()<dt.retargetChance)&&(r&&Math.random()<dt.enemyTargetPlayerChance&&s?i.ai.target={mesh:{position:s},name:Mo}:i.ai.target=wT(i.mesh.position,t)),!r&&Math.random()<dt.allyTargetCapitalChance){for(const x of R.capitalShips)if(x.alive){for(const m of x.subsystems)if(m.health>0){Vf.copy(m.center).applyMatrix4(x.mesh.matrixWorld),i.ai.target={mesh:{position:Vf.clone()},name:`Корабль-${x.mesh.userData.index+1}`};break}if(i.ai.target)break}}const o=i.ai.target;if(!o)return;jl.copy(o.mesh.position).sub(i.mesh.position);const l=jl.length(),c=jl.normalize();i.ai.timer-=e,i.ai.timer<=0&&(l<dt.evadeDistance?(i.ai.state="evade",i.ai.evadeDir.copy(c).negate(),i.ai.evadeDir.x+=(Math.random()-.5)*dt.evadeNoiseXZ,i.ai.evadeDir.y+=(Math.random()-.5)*dt.evadeNoiseY,i.ai.evadeDir.z+=(Math.random()-.5)*dt.evadeNoiseXZ,i.ai.evadeDir.normalize(),i.ai.timer=dt.evadeTimerBase+Math.random()*dt.evadeTimerRange):l>dt.chaseDistance?(i.ai.state="chase",i.ai.timer=dt.chaseTimer):(i.ai.state="orbit",i.ai.evadeDir.set(-c.z,(Math.random()-.5)*dt.orbitYNoise,c.x).normalize(),Math.random()<.5&&i.ai.evadeDir.negate(),i.ai.timer=dt.orbitTimerBase+Math.random()*dt.orbitTimerRange));let h;switch(i.ai.state){case"chase":h=c;break;case"evade":h=i.ai.evadeDir;break;case"orbit":{const x=(l-dt.orbitDistance)/dt.orbitDistance*dt.orbitCorrection;Hf.copy(i.ai.evadeDir).addScaledVector(c,x).normalize(),h=Hf;break}default:h=c}Of.set(1,0,0).applyQuaternion(i.mesh.quaternion),Lr.copy(Of).cross(h);const u=Lr.length();if(u>.001){const x=Math.asin(Math.min(1,u))*dt.turnRate*e;Lr.divideScalar(u),Bf.setFromAxisAngle(Lr,x),i.mesh.quaternion.premultiply(Bf),i.mesh.quaternion.normalize()}kf.setFromAxisAngle(AT.set(1,0,0),-Lr.y*dt.rollRate*e),i.mesh.quaternion.multiply(kf),zf.set(1,0,0).applyQuaternion(i.mesh.quaternion),i.mesh.position.addScaledVector(zf,i.speed*e),i.shootTimer-=e,i.shootTimer<=0&&l<dt.shootDistance&&(i.shootTimer=dt.shootTimerBase+Math.random()*dt.shootTimerRange,DE(i.mesh,c,n,i.name,a));const d=Math.sin(Date.now()*dt.exhaustPulseSpeed+i.mesh.id*dt.exhaustPulsePhaseMultiplier)*.5+.5,f=i.mesh.getObjectByName("exhaust");f&&(f.material.opacity=dt.exhaustOpacityBase+d*dt.exhaustOpacityRange,f.scale.setScalar(dt.exhaustScaleBase+d*dt.exhaustScaleRange)),i.healthBar.lookAt(Ke.position);const g=i.health/i.maxHealth;i.healthFill.scale.x=Math.max(.01,g),i.healthFill.position.x=-(1-g)*2}function RT(i,e){for(const t of R.allies)Nm(t,i,R.enemies,"ally",null,!1,e)}function CT(i,e){for(const t of R.enemies)Nm(t,i,R.allies,"enemy",e.position,!0,e)}const IT={id:"ai",update(i){RT(i,we),CT(i,we)},cleanup(){for(const i of R.allies)To(i.mesh);for(const i of R.enemies)To(i.mesh);R.allies=[],R.enemies=[]}},mn=oa,PT=mn.shipPositions.map(([i,e,t])=>new P(i,e,t));function LT(){const i=it.counts.capitalShips,e=on(it.colors.capitalHull);for(let t=0;t<i;t++){const n=tm(t,e);n.position.copy(PT[t]),n.lookAt(0,0,0),Et.add(n),R.capitalShips.push({mesh:n,subsystems:n.userData.subsystems,alive:!0,turretTimer:2+Math.random()*3})}}function Jl(i,e){for(const t of i.subsystems)t.health<=0&&t.mesh.visible&&t.mesh.traverse(n=>{n.isMesh&&n.material&&(n.material=SE)});i.subsystems[0].health>0&&(i.mesh.rotation.y+=mn.shipRotationSpeed*e)}const zs=[],Ql=new P,Gf=new P,ec=new P;function DT(i){for(const e of R.capitalShips){if(!e.alive)continue;if(e.subsystems[2].health<=0){Jl(e,i);continue}if(e.turretTimer-=i,e.turretTimer<=0){e.turretTimer=lt.turretFireRateMin+Math.random()*(lt.turretFireRateMax-lt.turretFireRateMin),zs.length=0;const n=e.mesh.position;n.distanceToSquared(we.position)<mn.turretRangeSq&&zs.push(we.position);for(const c of R.allies)n.distanceToSquared(c.mesh.position)<mn.allyTurretRangeSq&&zs.push(c.mesh.position);if(zs.length===0){Jl(e,i);continue}const s=zs[Math.floor(Math.random()*zs.length)];Ql.copy(s).sub(n).normalize();const a=e.subsystems[1].health<=0?lt.turretAccuracy*mn.turretInaccuracyMultiplier:lt.turretAccuracy;fu(Ql,a);const o=`Корабль-${e.mesh.userData.index+1}`,l=mn.turretBurstMin+Math.floor(Math.random()*mn.turretBurstRandomExtra);for(let c=0;c<l;c++)Gf.set(n.x+(Math.random()-.5)*mn.turretOriginSpreadXZ,n.y+(Math.random()-.5)*mn.turretOriginSpreadY,n.z+(Math.random()-.5)*mn.turretOriginSpreadXZ),ec.copy(Ql),fu(ec,mn.turretShotSpread),So(Gf,ec,"enemy",o);n.distanceToSquared(we.position)<mn.audioRangeSq&&Nu(!1)}Jl(e,i)}}const NT={id:"capital-ships",update(i){DT(i)},cleanup(){for(const i of R.capitalShips)To(i.mesh);R.capitalShips=[]}},Je=Dm.minimap,UT=document.getElementById("minimap-canvas"),_t=UT.getContext("2d"),tc=new P,ja=Math.PI*2;function FT(i){_t.clearRect(0,0,Je.size,Je.size);const e=Je.center,t=Je.center,n=Je.scale,s=i.position.x,r=i.position.z;_t.fillStyle="#00ccff",_t.beginPath(),_t.arc(e,t,Je.playerDotRadius,0,ja),_t.fill(),tc.set(1,0,0).applyQuaternion(i.quaternion),_t.strokeStyle="#00ccff",_t.lineWidth=1.5,_t.beginPath(),_t.moveTo(e,t),_t.lineTo(e+tc.x*Je.dirLineLength,t+tc.z*Je.dirLineLength),_t.stroke(),_t.fillStyle="#00ff66";for(const a of R.allies){const o=e+(a.mesh.position.x-s)*n,l=t+(a.mesh.position.z-r)*n;o>Je.padding&&o<Je.size-Je.padding&&l>Je.padding&&l<Je.size-Je.padding&&(_t.beginPath(),_t.arc(o,l,Je.dotRadius,0,ja),_t.fill())}_t.fillStyle="#ff2200";for(const a of R.enemies){const o=e+(a.mesh.position.x-s)*n,l=t+(a.mesh.position.z-r)*n;o>Je.padding&&o<Je.size-Je.padding&&l>Je.padding&&l<Je.size-Je.padding&&(_t.beginPath(),_t.arc(o,l,Je.dotRadius,0,ja),_t.fill())}_t.fillStyle="#ff8800";for(const a of R.capitalShips){if(!a.alive)continue;const o=e+(a.mesh.position.x-s)*n,l=t+(a.mesh.position.z-r)*n;o>Je.padding&&o<Je.size-Je.padding&&l>Je.padding&&l<Je.size-Je.padding&&_t.fillRect(o-Je.capitalShipMarkerSize,l-Je.capitalShipMarkerSize,Je.capitalShipMarkerSize*2,Je.capitalShipMarkerSize*2)}_t.strokeStyle="rgba(0,255,255,0.3)",_t.lineWidth=1,_t.beginPath(),_t.arc(Je.center,Je.center,Je.borderRadius,0,ja),_t.stroke()}function Um(){vE(),tT(we),FT(we)}function Fm(i){R.messageTimer>0&&(R.messageTimer-=i,R.messageTimer<=0&&xE())}const Ao=new Map;function nc(i,e){let t=Ao.get(i);t||(t=new Set,Ao.set(i,t)),t.add(e)}function ic(i,e){Ao.get(i)?.delete(e)}function da(i,e){const t=Ao.get(i);if(t)for(const n of t)try{n(e)}catch(s){console.error(`Event "${i}" handler error:`,s)}}const Qt=oa;function Om(i){const{victim:e,killerName:t,killerTeam:n,victimTeam:s,isPlayerKill:r}=i;zi(e.mesh.position.clone(),3),To(e.mesh);const a=s==="enemy"?R.enemies:R.allies,o=a.indexOf(e);o!==-1&&a.splice(o,1),dm(t,e.name,n,s),s==="enemy"&&R.totalEnemyKills++,r&&(R.score+=Qt.fighterKillScore,R.playerHealth=Math.min(R.maxHealth,R.playerHealth+R.maxHealth*Wo.killHealthBonus),ar(`+${Qt.fighterKillScore} | +10% HP`,1.5)),R.respawnQueue.push({team:s,timer:lt.respawnDelay})}function Bm(i){const{subsystem:e,ship:t}=i;zi(e.center.clone().applyMatrix4(t.mesh.matrixWorld),Qt.subsystemExplosionSize),R.score+=Qt.subsystemKillScore,ar(`${e.name} УНИЧТОЖЕНА! +${Qt.subsystemKillScore}`,2),t.subsystems.every(n=>n.health<=0)&&(t.alive=!1,da("capital-ship-destroyed",{ship:t,killerName:i.killerName}))}function km(i){const{ship:e}=i;zi(e.mesh.position.clone(),Qt.mainExplosionSize);for(let t=0;t<Qt.secondaryExplosionCount;t++)setTimeout(()=>{if(!e.mesh.parent)return;const n=new P((Math.random()-.5)*Qt.secondaryExplosionSpread.x,(Math.random()-.5)*Qt.secondaryExplosionSpread.y,(Math.random()-.5)*Qt.secondaryExplosionSpread.z);zi(e.mesh.position.clone().add(n),Qt.secondaryExplosionSize)},t*Qt.secondaryExplosionDelay);setTimeout(()=>{Et.remove(e.mesh)},Qt.shipRemoveDelay),R.score+=Qt.capitalShipKillScore,ar(`КОРАБЛЬ УНИЧТОЖЕН! +${Qt.capitalShipKillScore}`,3),R.phase===1&&R.capitalShips.every(t=>!t.alive)&&(R.phase=2,da("phase-changed",{phase:2}),setTimeout(()=>{ar(`ВСЕ КОРАБЛИ УНИЧТОЖЕНЫ!
Уничтожьте ${lt.killTarget} истребителей!`,4)},3500))}function OT(i,e,t,n,s){da("fighter-killed",{victim:i,killerName:e,killerTeam:t,victimTeam:n?"enemy":"ally",isPlayerKill:s})}function BT(i,e,t){da("subsystem-destroyed",{subsystem:i,ship:e,killerName:t})}function kT(){nc("fighter-killed",Om),nc("subsystem-destroyed",Bm),nc("capital-ship-destroyed",km)}function zT(){ic("fighter-killed",Om),ic("subsystem-destroyed",Bm),ic("capital-ship-destroyed",km)}const HT={id:"damage",init(){kT()},update(){},cleanup(){zT()}},na=oa,Wf=new P;function Xf(i,e,t){for(let n=e.length-1;n>=0;n--){const s=e[n];if(i.mesh.position.distanceToSquared(s.mesh.position)<na.fighterHitDistSq){if(s.health-=i.damage,zi(i.mesh.position.clone(),na.hitExplosionSize),s.health<=0){const r=i.shooterName||"?",a=i.team==="player"?"player":i.team==="ally"?"ally":"enemy",o=e===R.enemies;OT(s,r,a,o,t)}return!0}}return!1}function VT(i){for(const e of R.capitalShips)if(e.alive){for(const t of e.subsystems)if(!(t.health<=0)&&(Wf.copy(t.center).applyMatrix4(e.mesh.matrixWorld),i.mesh.position.distanceToSquared(Wf)<t.radius*t.radius))return t.health-=i.damage,zi(i.mesh.position.clone(),na.hitCapitalExplosionSize),t.health<=0&&BT(t,e,i.shooterName||"?"),!0}return!1}function GT(i){const e=[{arr:R.bullets,hitEnemies:!0,hitAllies:!1,hitPlayer:!1,isPlayer:!0},{arr:R.allyBullets,hitEnemies:!0,hitAllies:!1,hitPlayer:!1,isPlayer:!1},{arr:R.enemyBullets,hitEnemies:!1,hitAllies:!0,hitPlayer:!0,isPlayer:!1}];for(const{arr:t,hitEnemies:n,hitAllies:s,hitPlayer:r,isPlayer:a}of e)for(let o=t.length-1;o>=0;o--){const l=t[o];if(l.mesh.position.addScaledVector(l.velocity,i),l.life-=i,l.life<=0){Et.remove(l.mesh),t.splice(o,1);continue}let c=!1;n&&!c&&(c=Xf(l,R.enemies,a)),s&&!c&&(c=Xf(l,R.allies,!1)),r&&!c&&R.invulnTimer<=0&&l.mesh.position.distanceToSquared(we.position)<na.playerHitDistSq&&(R.playerHealth-=l.damage,R.damageFlash=Wo.damageFlashDuration,R.noDamageTimer=0,R.lastAttacker=l.shooterName||"?",zi(l.mesh.position.clone(),na.hitExplosionSize),zg(),da("player-hit",{damage:l.damage,attackerName:l.shooterName||"?"}),c=!0),(a||l.team==="ally")&&!c&&(c=VT(l)),c&&(Et.remove(l.mesh),t.splice(o,1))}LE()}function WT(){for(const i of R.bullets)Et.remove(i.mesh);for(const i of R.allyBullets)Et.remove(i.mesh);for(const i of R.enemyBullets)Et.remove(i.mesh);R.bullets=[],R.allyBullets=[],R.enemyBullets=[]}const XT={id:"bullets",update(i){GT(i)},cleanup(){WT()}},zm=[ub,UE,JE],Hm=[XT,AE],fs=oa;function Vm(i){const e=_r(on(it.colors.allyBody),on(it.colors.allyExhaust));Et.add(e);const t=new P((Math.random()-.5)*fs.allySpawnSpread.x,(Math.random()-.5)*fs.allySpawnSpread.y,(Math.random()-.5)*fs.allySpawnSpread.z);e.position.copy(i).add(t),e.quaternion.copy(we.quaternion);const n=sm(e,65348),s=sb();R.allies.push({mesh:e,name:s,healthBar:n.bar,healthFill:n.fill,health:lt.fighterHP,maxHealth:lt.fighterHP,speed:lt.allySpeedMin+Math.random()*(lt.allySpeedMax-lt.allySpeedMin),shootTimer:lt.allyFireRateMin+Math.random()*(lt.allyFireRateMax-lt.allyFireRateMin),ai:{state:"chase",timer:0,evadeDir:new P,target:null}})}function Gm(i){const e=_r(on(it.colors.enemyBody),on(it.colors.enemyExhaust));Et.add(e);const t=new P((Math.random()-.5)*fs.enemySpawnSpread.x,(Math.random()-.5)*fs.enemySpawnSpread.y,(Math.random()-.5)*fs.enemySpawnSpread.z);e.position.copy(i).add(t);const n=sm(e,16711680),s=rb();R.enemies.push({mesh:e,name:s,healthBar:n.bar,healthFill:n.fill,health:lt.fighterHP,maxHealth:lt.fighterHP,speed:lt.enemySpeedMin+Math.random()*(lt.enemySpeedMax-lt.enemySpeedMin),shootTimer:lt.enemyFireRateMin+Math.random()*(lt.enemyFireRateMax-lt.enemyFireRateMin),ai:{state:"chase",timer:0,evadeDir:new P,target:null}})}function qT(i){for(let e=R.respawnQueue.length-1;e>=0;e--)if(R.respawnQueue[e].timer-=i,R.respawnQueue[e].timer<=0)if(R.respawnQueue.splice(e,1)[0].team==="ally")Vm(we.position);else{let n=new P(...fs.defaultEnemySpawnPos);const s=R.capitalShips.filter(r=>r.alive);s.length>0&&(n=s[Math.floor(Math.random()*s.length)].mesh.position.clone()),Gm(n)}}const YT={id:"spawner",update(i){qT(i)},cleanup(){R.respawnQueue=[]}};function KT(i){for(const e of i)e.init?.()}function Wm(i,e){for(const t of i)t.update(e)}function Xm(i){for(const e of i)e.cleanup?.()}const $T=document.getElementById("enemy-indicators"),qf=new hh($T,()=>{const i=document.createElement("div");return i.className="enemy-indicator",i.innerHTML='<div class="arrow"></div><div class="dist"></div>',i});function jT(i){const t=window.innerWidth,n=window.innerHeight;let s=0;for(const r of R.capitalShips){if(!r.alive)continue;const a=yi(r.mesh.position,Ke,t,n),o=a.z<1;if(o&&a.x>40&&a.x<t-40&&a.y>40&&a.y<n-40)continue;const c=qf.get(s);s++;const h=dh(a.x,a.y,t,n,!o,40),u=a.x-t/2,d=a.y-n/2,f=Math.atan2(o?d:-d,o?u:-u),g=i.position.distanceTo(r.mesh.position);c.style.left=h.x+"px",c.style.top=h.y+"px",c.style.transform="translate(-50%, -50%)",c.children[0].style.transform=`rotate(${f*180/Math.PI-90}deg)`,c.children[0].style.borderBottomColor="#ff8800",c.children[1].textContent="★ "+Am(g),c.children[1].style.color="#ff8800",c.style.opacity="0.9"}qf.hideFrom(s)}const ZT=document.getElementById("target-markers"),$s=new hh(ZT,()=>{const i=document.createElement("div");return i.className="target-marker",i.innerHTML='<div class="diamond"></div><div class="marker-dist"></div><div class="marker-label"></div>',i}),In=new P,qm=800*800,Ym=1500*1500;function Yf(i,e,t,n){for(const s of R.capitalShips){if(!s.alive)continue;const r=n.position.distanceToSquared(s.mesh.position);if(!(r>Ym))if(r>tb){const a=yi(s.mesh.position,Ke,e,t);if(a.z>=1||a.x<-20||a.x>e+20||a.y<-20||a.y>t+20)continue;const o=$s.get(i++);o.className="target-marker capital",o.style.left=a.x+"px",o.style.top=a.y+"px";const l=Math.sqrt(r);o.children[1].textContent=Math.floor(l)+"m",o.children[2].textContent=`Корабль-${s.mesh.userData.index+1}`,o.children[0].style.width="28px",o.children[0].style.height="28px"}else for(const a of s.subsystems){if(a.health<=0)continue;In.copy(a.center).applyMatrix4(s.mesh.matrixWorld);const o=n.position.distanceTo(In),l=yi(In,Ke,e,t);if(l.z>=1||l.x<-20||l.x>e+20||l.y<-20||l.y>t+20)continue;const c=$s.get(i++);c.className="target-marker capital",c.style.left=l.x+"px",c.style.top=l.y+"px",c.children[1].textContent=Math.floor(o)+"m",c.children[2].textContent=a.name,c.children[0].style.width="21px",c.children[0].style.height="21px"}}return i}function JT(i,e,t,n,s){let r,a;i.kind==="fighter"?(r=s.position.distanceTo(i.fighter.mesh.position),In.copy(i.fighter.mesh.position),a=i.fighter.name):(In.copy(i.subsystem.center).applyMatrix4(i.ship.mesh.matrixWorld),r=s.position.distanceTo(In),a=i.subsystem.name);let o=yi(In,Ke,t,n);if(o.z>=1||o.x<0||o.x>t||o.y<0||o.y>n){const u=dh(o.x,o.y,t,n,o.z>=1,40);o={x:u.x,y:u.y,z:o.z}}const l=$s.get(e++),c=i.kind==="subsystem";l.className="target-marker target-locked"+(c?" capital":""),l.style.left=o.x+"px",l.style.top=o.y+"px",l.children[1].textContent=Math.floor(r)+"m",l.children[2].textContent=a;const h=c?1:Math.max(.6,Math.min(1.5,300/r));return l.children[0].style.width=21*h+"px",l.children[0].style.height=21*h+"px",e}function QT(i){const e=window.innerWidth,t=window.innerHeight,n=(R.mouseX*.5+.5)*e,s=(R.mouseY*.5+.5)*t;let r=0;if(R.lockedTarget){const l=R.lockedTarget;l.kind==="fighter"?(l.fighter.health<=0||!R.enemies.includes(l.fighter))&&(R.lockedTarget=null):(l.subsystem.health<=0||!l.ship.alive)&&(R.lockedTarget=null)}if(R.lockedTarget){r=Yf(r,e,t,i),r=JT(R.lockedTarget,r,e,t,i),$s.hideFrom(r);return}const a=Math.sqrt(e*e+t*t),o=(eb*a)**2;for(const l of R.enemies){const c=i.position.distanceToSquared(l.mesh.position);if(c>qm)continue;const h=yi(l.mesh.position,Ke,e,t);if(h.z>=1||h.x<-20||h.x>e+20||h.y<-20||h.y>t+20)continue;const u=h.x-n,d=h.y-s;if(u*u+d*d>o)continue;const f=$s.get(r++);f.className="target-marker",f.style.left=h.x+"px",f.style.top=h.y+"px";const g=Math.sqrt(c);f.children[1].textContent=Math.floor(g)+"m",f.children[2].textContent=l.name;const x=Math.max(.6,Math.min(1.5,300/g));f.children[0].style.width=21*x+"px",f.children[0].style.height=21*x+"px"}r=Yf(r,e,t,i),$s.hideFrom(r)}function Km(i){if(R.lockedTarget){R.lockedTarget=null;return}const e=window.innerWidth,t=window.innerHeight,n=(R.mouseX*.5+.5)*e,s=(R.mouseY*.5+.5)*t,r=sf*sf;let a=null,o=1/0;for(const l of R.enemies){if(i.position.distanceToSquared(l.mesh.position)>qm)continue;const c=yi(l.mesh.position,Ke,e,t);if(c.z>=1)continue;const h=(c.x-n)**2+(c.y-s)**2;h<r&&h<o&&(o=h,a={kind:"fighter",fighter:l})}for(const l of R.capitalShips)if(l.alive&&!(i.position.distanceToSquared(l.mesh.position)>Ym))for(const c of l.subsystems){if(c.health<=0)continue;In.copy(c.center).applyMatrix4(l.mesh.matrixWorld);const h=yi(In,Ke,e,t);if(h.z>=1)continue;const u=(h.x-n)**2+(h.y-s)**2;u<r&&u<o&&(o=u,a={kind:"subsystem",subsystem:c,ship:l})}if(!a){let l=1/0;for(const c of R.enemies){const h=i.position.distanceToSquared(c.mesh.position);h<l&&(l=h,a={kind:"fighter",fighter:c})}for(const c of R.capitalShips)if(c.alive)for(const h of c.subsystems){if(h.health<=0)continue;In.copy(h.center).applyMatrix4(c.mesh.matrixWorld);const u=i.position.distanceToSquared(In);u<l&&(l=u,a={kind:"subsystem",subsystem:h,ship:c})}}R.lockedTarget=a}const sc=[...zm,...Hm,IT,NT,YT,HT];function eA(){R.killFeed=[],R.phase=1,R.score=0,R.lives=5,R.playerHealth=100,R.totalEnemyKills=0,R.lastAttacker="",R.baseSpeed=80,R.boostSpeed=160,R.speedDecay=!0,R.speed=R.baseSpeed,R.shootCooldown=0,R.messageTimer=0,R.damageFlash=0,R.noDamageTimer=0,R.invulnTimer=0,R.keys={},R.mouseX=0,R.mouseY=0,R.lockedTarget=null,_E(),ib(),ME(),we.position.set(0,0,0),we.quaternion.identity(),we.visible=!0,Vt.pitch=0,Vt.yaw=0,Vt.roll=0,Ke.position.set(-10.5,3.75,0),Ke.lookAt(we.position),vt.playerModel&&we.remove(vt.playerModel),vt.playerModel=_r(on(it.colors.playerBody),on(it.colors.playerExhaust)),we.add(vt.playerModel)}function tA(){const i=Math.min(lt.capitalShips,5);it.counts.capitalShips=i,LT();const e=lt.allies;for(let n=0;n<e;n++)Vm(we.position);const t=lt.enemies;for(let n=0;n<t;n++){const s=n%Math.max(1,R.capitalShips.length);Gm(R.capitalShips[s].mesh.position)}}function nA(i){const e=Dm.damageEffect;if(R.damageFlash>0?(R.damageFlash-=i,Kn.domElement.style.boxShadow=`inset 0 0 ${e.flashGlowSize*R.damageFlash}px rgba(255,0,0,${R.damageFlash})`):Kn.domElement.style.boxShadow="none",R.playerHealth<e.lowHealthThreshold&&R.running){const t=Math.sin(Date.now()*e.lowHealthPulseSpeed)*.5+.5;Kn.domElement.style.boxShadow=`inset 0 0 ${e.lowHealthGlowSize*t}px rgba(255,0,0,${e.lowHealthGlowOpacity*t})`}}function iA(){let i=1/0;for(const e of R.allies){const t=we.position.distanceToSquared(e.mesh.position);t<i&&(i=t)}for(const e of R.enemies){const t=we.position.distanceToSquared(e.mesh.position);t<i&&(i=t)}kg(i)}function sA(i){iA(),nA(i),yE(i),vt.hudFrameCounter++,vt.hudFrameCounter%2===0&&(Um(),jT(we),QT(we)),Fm(i)}function rA(){R.phase!==1&&R.phase===2&&R.totalEnemyKills>=lt.killTarget&&(R.running=!1,gs?Lm(!0,R.score):(document.getElementById("victory-score").textContent=`Счёт: ${R.score} | Уничтожено: ${R.totalEnemyKills}`,document.getElementById("victory-screen").style.display="flex"))}function aA(){FE(),R.lives<=0&&gs&&!R.running&&(document.getElementById("game-over").style.display="none",Lm(!1,R.score))}const oA={update(i){!R.running||vt.paused||(Wm(sc,i),vt.explorationTime+=i,bm(i,vt.explorationTime),sA(i),R.playerHealth<=0&&aA(),rA(),R.running||(fc(),Uh()))},enter(i){i?.combatConfig&&JS(i.combatConfig),Du()||Lu(),ci(),KT(sc),eA(),tA(),cm(),cp(),Bg(),R.running=!0,ar("В БОЙ!",2)},exit(){R.running=!1,fc(),Uh(),um(),Xm(sc),Kn.domElement.style.boxShadow="none"}},lA={rocky:"Каменная",gas_giant:"Газовый гигант",ice:"Ледяная",desert:"Пустынная",ocean:"Океаническая",volcanic:"Вулканическая",barren:"Безжизненная"},gu={hud(i){return`<div class="expl-system-name">${i}</div><button class="gal-btn expl-return-btn" id="expl-return-btn">НАЗАД К КАРТЕ</button>`},planetInfo(i){const e=i.hasLiquidWater?"Есть":"Нет",t=i.hasOxygen?"Есть":"Нет",n=i.radiationLevel<.2?"Низкая":i.radiationLevel<.5?"Средняя":i.radiationLevel<.8?"Высокая":"Критическая",s=i.radiationLevel<.2?"#44ff88":i.radiationLevel<.5?"#ffaa44":"#ff4444";return`<div class="expl-planet-card"><h3>${i.name}</h3><div class="expl-planet-type">${lA[i.type]||i.type}</div><div class="expl-planet-stat">Размер: ${i.size.toFixed(1)}</div><div class="expl-planet-stat">Вода: ${e}</div><div class="expl-planet-stat">Кислород: ${t}</div><div class="expl-planet-stat" style="color:${s}">Радиация: ${n}</div></div>`},noPlanetNearby(){return'<div class="expl-hint">Подлетите ближе к планете для информации</div>'}};let Di=null,Vn=null,rc=null,_u=-2;function cA(i){rc=i,Di||(Di=document.createElement("div"),Di.id="exploration-hud",document.body.appendChild(Di)),Vn||(Vn=document.createElement("div"),Vn.id="exploration-planet-info",document.body.appendChild(Vn));const e=jt(ae.currentSystemId);Di.innerHTML=gu.hud(e.name),Di.style.display="block",Vn.style.display="block",_u=-2;const t=document.getElementById("expl-return-btn");t&&t.addEventListener("click",()=>{rc&&rc()})}function uA(){if(!Vn)return;const i=gi.nearestPlanetIndex;if(i!==_u)if(_u=i,i<0)Vn.innerHTML=gu.noPlanetNearby();else{const e=ch();e&&e.planets[i]&&(Vn.innerHTML=gu.planetInfo(e.planets[i]))}}function hA(){Di&&(Di.style.display="none"),Vn&&(Vn.style.display="none")}const Kf=[...zm,...Hm];function $f(i){const e=document.getElementById("hud");e&&(i?e.classList.add("exploration-mode"):e.classList.remove("exploration-mode"))}const dA={update(i){Wm(Kf,i),vt.explorationTime+=i,bm(i,vt.explorationTime),uA(),vt.hudFrameCounter++,vt.hudFrameCounter%2===0&&Um(),Fm(i)},enter(i){const e=i?.systemId,t=i?.exitCallback;ym(),e&&Mm(e),Sm(),Yo(!0);const[n,s,r]=hn.startPosition;we.position.set(n,s,r),we.quaternion.identity(),Vt.pitch=0,Vt.yaw=0,Vt.roll=0,we.visible=!0,R.baseSpeed=hn.baseSpeed,R.boostSpeed=hn.boostSpeed,R.speedDecay=!1,R.speed=hn.initialSpeed,R.mouseX=0,R.mouseY=0,R.shootCooldown=0,R.damageFlash=0,R.playerHealth=100,vt.explorationTime=0,Ke.near=1,Ke.updateProjectionMatrix(),Ke.position.set(n-10.5,s+3.75,r),Ke.lookAt(we.position),cm(),$f(!0),t&&cA(t),Du()||Lu(),ci(),cp()},exit(){hA(),qo(),la(),Ko(),$f(!1),um(),fc(),Xm(Kf),we.visible=!1}},Wt=new rn;Wt.visible=!1;const Sn=new Map,Hr=new Map,ac=[],uo=new Map,hs=new Set,Fr=new Map,wo=[],xu=[],Ae={playerShipModel:null,selectionRing:null,contractMarker:null,labelsContainer:null,twinkleTimeUniform:null,mainStarsMat:null,brightStarsMat:null,galaxyBrightness:1},Hs={time:0};new P;const fA=.34,pA=.13,$m=1,jm=.5,mA=3;let oc=null,lc=null;function gA(){return oc||(oc=xA()),oc}function _A(){return lc||(lc=vA()),lc}function xA(){const e=document.createElement("canvas");e.width=128,e.height=128;const t=e.getContext("2d"),n=128/2,s=t.createRadialGradient(n,n,0,n,n,n);s.addColorStop(0,"rgba(255,255,255,1)"),s.addColorStop(.15,"rgba(255,255,255,0.6)"),s.addColorStop(.4,"rgba(255,255,255,0.15)"),s.addColorStop(1,"rgba(255,255,255,0)"),t.fillStyle=s,t.fillRect(0,0,128,128);const r=new eh(e);return r.generateMipmaps=!1,r.minFilter=wt,r}function vA(){const e=document.createElement("canvas");e.width=64,e.height=64;const t=e.getContext("2d"),n=64/2,s=t.createRadialGradient(n,n,0,n,n,n);s.addColorStop(0,"rgba(255,255,255,1)"),s.addColorStop(.5,"rgba(255,255,255,0.8)"),s.addColorStop(.8,"rgba(255,255,255,0.15)"),s.addColorStop(1,"rgba(255,255,255,0)"),t.fillStyle=s,t.fillRect(0,0,64,64);const r=new eh(e);return r.generateMipmaps=!1,r.minFilter=wt,r}const jf=[6737151,16755268,8978278,16737928,16768324,11176191,4521932,16746564],cc=[[.55,.65,1],[.7,.8,1],[.95,.92,1],[1,.95,.8],[1,.85,.55],[1,.7,.4],[1,.5,.3],[1,.6,.5],[.8,.75,1],[.9,.95,.7]];function yA(){const i=new rn,e=5,t=1e6,n=55e4,s=n+18e4,r=s+15e4,a=r+8e4,o=new Float32Array(t*3),l=new Float32Array(t*3);let c=0;const h=2*Math.PI;function u(){return Math.sqrt(-2*Math.log(Math.random()||1e-4))*Math.cos(h*Math.random())}const d=120,f=new Float32Array(d),g=new Float32Array(d),x=new Float32Array(d),m=new Uint8Array(d);for(let L=0;L<d;L++){const Z=Math.random()*h,$=5+Math.random()*80;f[L]=$*Math.cos(Z)+u()*5,g[L]=$*Math.sin(Z)+u()*5,x[L]=5+Math.random()*15,m[L]=Math.floor(Math.random()*cc.length)}function p(L,Z,$){let re=1/0,ce=-1,ue=1/0,Fe=-1;for(let ee=0;ee<d;ee++){const Pe=L-f[ee],_e=Z-g[ee],Me=Pe*Pe+_e*_e;Me<re?(ue=re,Fe=ce,re=Me,ce=ee):Me<ue&&(ue=Me,Fe=ee)}const tt=Math.sqrt(re),Ne=Math.max(0,1-tt/(x[ce]*1.5));if(Ne>.05&&ce>=0){const ee=cc[m[ce]];let Pe=ee[0],_e=ee[1],Me=ee[2];if(Fe>=0&&Ne<.5){const $e=cc[m[Fe]],Ze=Ne*2;Pe=Pe*Ze+$e[0]*(1-Ze),_e=_e*Ze+$e[1]*(1-Ze),Me=Me*Ze+$e[2]*(1-Ze)}const ct=.9+Math.random()*.2;return[Pe*$*ct,_e*$*ct,Me*$*ct]}const W=Math.random(),J=$*(.9+Math.random()*.2);return W<.3?[J,J*.7,J*.4]:W<.55?[J,J*.88,J*.6]:W<.75?[J*.9,J*.92,J]:W<.9?[J*.7,J*.8,J]:[J,J*.95,J*.85]}const y=80,S=new Float32Array(y),M=new Float32Array(y),T=new Float32Array(y);for(let L=0;L<y;L++){const Z=Math.random()*h,$=3+Math.random()*75;S[L]=$*Math.cos(Z),M[L]=$*Math.sin(Z),T[L]=2+Math.random()*6}function A(L,Z){for(let $=0;$<y;$++){const re=L-S[$],ce=Z-M[$],ue=re*re+ce*ce,Fe=T[$]*T[$]*4;if(ue<Fe){const tt=.3+Math.random()*.4;return[L-re*tt+u()*T[$]*.3,Z-ce*tt+u()*T[$]*.3]}}return null}for(let L=0;L<t;L++){let Z,$,re,ce;if(L<n){const Ne=L%e,W=.03+Math.random()*.97,J=W*4.2+Ne*h/e,ee=Math.sin(W*12+Ne)*.3+Math.sin(W*5.7+Ne*3)*.2+Math.sin(W*23+Ne*7)*.1,Pe=W*88,_e=(10+Pe*.18)*(.4+Math.random()*.6),Me=J+ee+Math.PI/2,ct=u()*_e*.45;Z=Pe*Math.cos(J+ee)+ct*Math.cos(Me)+u()*3.5,$=Pe*Math.sin(J+ee)+ct*Math.sin(Me)+u()*3.5,re=u()*1.5*(1-W*.5),ce=.09+Math.random()*.22}else if(L<s){const Ne=Math.random()*h,W=Math.abs(u())*12,J=.45,ee=1.8,Pe=W*Math.cos(Ne),_e=W*Math.sin(Ne)/ee,Me=Math.cos(J),ct=Math.sin(J);Z=Pe*Me-_e*ct+u()*2,$=Pe*ct+_e*Me+u()*2,re=u()*1.5*Math.max(.15,1-W/20),ce=.15+Math.random()*.26}else if(L<r){const Ne=Math.random()*h,W=3+Math.random()*85;Z=W*Math.cos(Ne)+u()*6,$=W*Math.sin(Ne)+u()*6,re=u()*2*(1-W/120),ce=.06+Math.random()*.16}else if(L<a){const Ne=Math.random()*h,W=Math.sqrt(Math.random())*90;Z=W*Math.cos(Ne)+u()*2,$=W*Math.sin(Ne)+u()*2,re=u()*.8*(1-W/100),ce=.045+Math.random()*.13}else{const Ne=Math.random()*h,W=8+Math.random()*95;Z=W*Math.cos(Ne)+u()*12,$=W*Math.sin(Ne)+u()*12,re=u()*5,ce=.03+Math.random()*.075}if(L<a&&Math.random()<.15){const Ne=A(Z,$);Ne&&(Z=Ne[0],$=Ne[1])}o[c*3]=Z,o[c*3+1]=re,o[c*3+2]=$;const[ue,Fe,tt]=p(Z,$,ce);l[c*3]=ue,l[c*3+1]=Fe,l[c*3+2]=tt,c++}const C=new Lt;C.setAttribute("position",new At(o,3)),C.setAttribute("color",new At(l,3));const _=_A(),E=new jr({size:.25,map:_,vertexColors:!0,transparent:!0,opacity:.34,depthWrite:!1,blending:bn,sizeAttenuation:!0});E.onBeforeCompile=L=>{L.vertexShader=L.vertexShader.replace("#include <clipping_planes_vertex>",`gl_PointSize = min(gl_PointSize, 64.0);
...
#include <premultiplied_alpha_fragment>`)},Ae.brightStarsMat=G,i.add(new yo(X,G)),i}function Zm(){Ae.labelsContainer||(Ae.labelsContainer=document.createElement("div"),Ae.labelsContainer.id="galaxy-labels",document.body.appendChild(Ae.labelsContainer));for(const i of uo.values())i.remove();uo.clear();for(const i of hs){const e=jt(i);if(!e)continue;const t=document.createElement("div");t.className="galaxy-label",t.textContent=e.name+(vm(i)?" ⌂":""),Ae.labelsContainer.appendChild(t),uo.set(e.id,t)}}function MA(i){if(!Ae.labelsContainer)return;const e=window.innerWidth,t=window.innerHeight;for(const[n,s]of uo){const r=Sn.get(n);if(!r)continue;const a=yi(r.position,i,e,t);if(a.z>1){s.style.display="none";continue}s.style.display="",s.style.left=`${a.x}px`,s.style.top=`${a.y+18}px`,s.classList.toggle("current",n===ae.currentSystemId),s.classList.toggle("contract-target",ae.activeContract?.targetSystemId===n)}}const SA=6;function Jm(){hs.clear();const i=[[ae.currentSystemId,0]];for(hs.add(ae.currentSystemId);i.length>0;){const[e,t]=i.shift();if(t>=SA)continue;const n=jt(e);if(n)for(const s of n.connections)hs.has(s)||(hs.add(s),i.push([s,t+1]))}}function Zf(i,e){const n=document.createElement("canvas");n.width=256,n.height=256;const s=n.getContext("2d"),r=256/2,a=s.createRadialGradient(r,r,0,r,r,r),o=new De().setHSL(i,e,.5),l=Math.round(o.r*255),c=Math.round(o.g*255),h=Math.round(o.b*255);a.addColorStop(0,`rgba(${l},${c},${h},0.6)`),a.addColorStop(.3,`rgba(${l},${c},${h},0.2)`),a.addColorStop(.6,`rgba(${l},${c},${h},0.05)`),a.addColorStop(1,`rgba(${l},${c},${h},0)`),s.fillStyle=a,s.fillRect(0,0,256,256);const u=new eh(n);return u.generateMipmaps=!1,u.minFilter=wt,u}function bA(){const i=new rn,e=[{hue:.6,sat:.8,pos:[25,.5,-18],scale:20,opacity:.045},{hue:.55,sat:.7,pos:[-22,-.3,-25],scale:25,opacity:.037},{hue:.75,sat:.6,pos:[-35,.2,15],scale:22,opacity:.037},{hue:0,sat:.7,pos:[40,-.5,20],scale:18,opacity:.03},{hue:.85,sat:.5,pos:[10,.3,40],scale:24,opacity:.037},{hue:.12,sat:.6,pos:[0,0,0],scale:30,opacity:.06},{hue:.08,sat:.4,pos:[2,0,-3],scale:20,opacity:.045},{hue:.58,sat:.9,pos:[50,0,-30],scale:28,opacity:.022},{hue:.7,sat:.7,pos:[-45,0,-35],scale:22,opacity:.026},{hue:.45,sat:.6,pos:[-30,0,45],scale:26,opacity:.026},{hue:.15,sat:.5,pos:[30,0,50],scale:20,opacity:.022},{hue:.65,sat:.3,pos:[0,-1,30],scale:50,opacity:.015},{hue:.5,sat:.3,pos:[-20,.5,-10],scale:55,opacity:.015}];wo.length=0,xu.length=0;for(const s of e){const r=Zf(s.hue,s.sat),a=new $r({map:r,transparent:!0,opacity:s.opacity,blending:bn,depthWrite:!1});wo.push(a),xu.push(s.opacity);const o=new _o(a);o.position.set(...s.pos),o.scale.setScalar(s.scale),i.add(o)}const t=[{pos:[15,0,-8],scale:15,opacity:.09},{pos:[-12,0,10],scale:18,opacity:.075},{pos:[30,0,5],scale:12,opacity:.067},{pos:[-8,0,-30],scale:14,opacity:.06},{pos:[5,0,25],scale:16,opacity:.075}],n=Zf(0,0);for(const s of t){const r=new $r({map:n,transparent:!0,opacity:s.opacity,color:197384,depthWrite:!1}),a=new _o(r);a.position.set(...s.pos),a.scale.setScalar(s.scale),i.add(a)}return i}function Qm(){for(const e of ac)Wt.remove(e),e.geometry.dispose(),e.material.dispose();ac.length=0;const i=jt(ae.currentSystemId);if(i)for(const e of i.connections){const t=Sn.get(ae.currentSystemId),n=Sn.get(e);if(!t||!n)continue;const s=[t.position,n.position],r=new Lt().setFromPoints(s),a=new Qu({color:52479,transparent:!0,opacity:.5}),o=new Fo(r,a);Wt.add(o),ac.push(o)}}function EA(i){Hs.time+=i,Ae.twinkleTimeUniform&&(Ae.twinkleTimeUniform.value=Hs.time);const e=Hr.get(ae.currentSystemId);if(e){const r=3+Math.sin(Hs.time*3)*.5;e.scale.setScalar(r)}if(Ae.contractMarker&&Ae.contractMarker.visible&&(Ae.contractMarker.rotation.y+=i*2,Ae.contractMarker.position.y=Ae.contractMarker.userData.baseY+Math.sin(Hs.time*4)*.5),Ae.playerShipModel&&(Ae.playerShipModel.rotation.y+=i*.5),Ae.selectionRing&&Ae.selectionRing.visible){const r=Ae.selectionRing.material;r.opacity=.5+Math.sin(Hs.time*4)*.2}const t=10,n=5,s=Ke.position;for(const[r,a]of Sn){const o=hs.has(r)?$m:jm,l=Fr.get(r)??o,c=o-l;if(Math.abs(c)>.005){const f=l+c*Math.min(1,i*mA);Fr.set(r,f),a.scale.setScalar(f)}else l!==o&&(Fr.set(r,o),a.scale.setScalar(o));const h=Hr.get(r);if(!h)continue;const u=s.distanceTo(a.position),d=Math.max(0,Math.min(1,(u-n)/(t-n)));if(r===ae.currentSystemId)h.material.opacity=d*(.8+Math.sin(Hs.time*3)*.2);else{const f=Fr.get(r)??o;h.scale.setScalar(2.5*f),h.material.opacity=d*.7}}}function Jf(i){Ae.galaxyBrightness=i,Ae.mainStarsMat&&(Ae.mainStarsMat.opacity=fA*i),Ae.brightStarsMat&&(Ae.brightStarsMat.opacity=pA*i);for(let e=0;e<wo.length;e++)wo[e].opacity=xu[e]*i}function TA(){for(;Wt.children.length>0;)Wt.remove(Wt.children[0]);Sn.clear(),Hr.clear();const i=new Ho(3359846,.6);Wt.add(i),Wt.add(yA()),Wt.add(bA());const e=new hr(.4,8,8),t=gA();for(let o=0;o<bo.length;o++){const l=bo[o],c=jf[o%jf.length],h=new Rt({color:c}),u=new Mt(e,h);u.position.set(...l.position),u.userData.systemId=l.id,Wt.add(u),Sn.set(l.id,u);const d=new $r({map:t,color:c,transparent:!0,opacity:.7,blending:bn,depthWrite:!1}),f=new _o(d);f.position.set(...l.position),f.scale.setScalar(2.5),Wt.add(f),Hr.set(l.id,f)}const n=new Jr(.7,.9,32),s=new Rt({color:16776960,transparent:!0,opacity:.7,side:en});Ae.selectionRing=new Mt(n,s),Ae.selectionRing.rotation.x=-Math.PI/2,Ae.selectionRing.visible=!1,Wt.add(Ae.selectionRing);const r=new nh(.5,0),a=new Rt({color:16724787});Ae.contractMarker=new Mt(r,a),Ae.contractMarker.visible=!1,Wt.add(Ae.contractMarker),Ae.playerShipModel=_r(on(it.colors.playerBody),on(it.colors.playerExhaust)),Ae.playerShipModel.scale.setScalar(.3),Wt.add(Ae.playerShipModel),xh(),Jm();for(const[o,l]of Sn){const c=hs.has(o)?$m:jm;Fr.set(o,c),l.scale.setScalar(c);const h=Hr.get(o);h&&h.scale.setScalar(2.5*c)}Qm(),Zm()}function xh(){const i=Sn.get(ae.currentSystemId);i&&Ae.playerShipModel&&(Ae.playerShipModel.position.copy(i.position),Ae.playerShipModel.position.y+=2.5)}function Qf(i){const e=Sn.get(i);return e?e.position.clone():null}function AA(i){Ae.playerShipModel&&Ae.playerShipModel.position.set(i.x,i.y+2.5,i.z)}function vu(i){if(!Ae.selectionRing)return;if(!i){Ae.selectionRing.visible=!1;return}const e=Sn.get(i);e&&(Ae.selectionRing.position.copy(e.position),Ae.selectionRing.position.y+=.05,Ae.selectionRing.visible=!0)}function vh(){if(Ae.contractMarker){if(ae.activeContract){const i=Sn.get(ae.activeContract.targetSystemId);if(i){Ae.contractMarker.position.copy(i.position),Ae.contractMarker.userData.baseY=i.position.y+3.5,Ae.contractMarker.position.y=Ae.contractMarker.userData.baseY,Ae.contractMarker.visible=!0;return}}Ae.contractMarker.visible=!1}}function wA(){Wt.visible=!0,Yo(!1),Ke.near=5,Ke.updateProjectionMatrix(),Ae.labelsContainer&&(Ae.labelsContainer.style.display="block")}function RA(){Wt.visible=!1,Yo(!0),Ke.near=1,Ke.updateProjectionMatrix(),Ae.selectionRing&&(Ae.selectionRing.visible=!1),Ae.labelsContainer&&(Ae.labelsContainer.style.display="none")}function CA(){return Sn}function yh(){Jm(),Qm(),Zm()}let Ro=0,js=Math.PI/4,ki=52;const Oi=new P(0,0,0);function Hi(){const i=Oi.x+ki*Math.sin(js)*Math.sin(Ro),e=Oi.y+ki*Math.cos(js),t=Oi.z+ki*Math.sin(js)*Math.cos(Ro);Ke.position.set(i,e,t),Ke.lookAt(Oi)}function IA(){Ke.up.set(0,1,0);const i=jt(ae.currentSystemId);Oi.set(...i.position),Ro=0,js=Math.PI/4,ki=52,Hi()}function PA(){Ke.up.set(0,1,0);const i=jt(ae.currentSystemId);Oi.set(...i.position)}function eg(i,e){Ro-=i,js=Math.max(.2,Math.min(Math.PI/2.2,js-e))}function LA(i){ki=Math.max(10,Math.min(120,ki+i))}function DA(){return ki}function NA(i){ki=Math.max(10,Math.min(120,i))}function UA(i,e,t){Oi.set(i,e,t)}function FA(i,e,t){Oi.lerpVectors(i,e,t)}let es=null;function tg(){return"ontouchstart"in window||navigator.maxTouchPoints>0}function OA(i){if(!tg())return;const e=document.getElementById("mouse-cursor");e&&(e.style.display="none");const t=document.getElementById("touch-controls");t.innerHTML="";const n=document.createElement("div");n.className="touch-aim-zone",t.appendChild(n);let s=null,r=0,a=0;const o=150;n.addEventListener("touchstart",T=>{T.preventDefault(),ci();for(const A of Array.from(T.changedTouches))s===null&&(s=A.identifier,r=A.clientX,a=A.clientY,es!==null&&(clearInterval(es),es=null))},{passive:!1}),n.addEventListener("touchmove",T=>{T.preventDefault();for(const A of Array.from(T.changedTouches))if(A.identifier===s){const C=A.clientX-r,_=A.clientY-a;R.mouseX=ep(C/o,-1,1),R.mouseY=ep(_/o,-1,1),R.mouseActive=!0}},{passive:!1});const l=T=>{for(const A of Array.from(T.changedTouches))A.identifier===s&&(s=null,es=window.setInterval(()=>{R.mouseX*=.8,R.mouseY*=.8,Math.abs(R.mouseX)<.01&&Math.abs(R.mouseY)<.01&&(R.mouseX=0,R.mouseY=0,es!==null&&(clearInterval(es),es=null))},16))};n.addEventListener("touchend",l),n.addEventListener("touchcancel",l);const c=document.createElement("div");c.className="touch-joystick";const h=document.createElement("div");h.className="touch-joystick-knob",c.appendChild(h),t.appendChild(c);let u=null,d=0,f=0;const g=40,x=.3;c.addEventListener("touchstart",T=>{T.preventDefault(),ci();for(const A of Array.from(T.changedTouches))if(u===null){u=A.identifier;const C=c.getBoundingClientRect();d=C.left+C.width/2,f=C.top+C.height/2}},{passive:!1}),c.addEventListener("touchmove",T=>{T.preventDefault();for(const A of Array.from(T.changedTouches))if(A.identifier===u){let C=A.clientX-d,_=A.clientY-f;const E=Math.sqrt(C*C+_*_);E>g&&(C=C/E*g,_=_/E*g),h.style.transform=`translate(${C-25}px, ${_-25}px)`;const B=C/g,I=_/g;R.keys.KeyA=B<-x,R.keys.KeyD=B>x,R.keys.KeyW=I<-x,R.keys.KeyS=I>x}},{passive:!1});const m=T=>{for(const A of Array.from(T.changedTouches))A.identifier===u&&(u=null,h.style.transform="translate(-25px, -25px)",R.keys.KeyA=!1,R.keys.KeyD=!1,R.keys.KeyW=!1,R.keys.KeyS=!1)};c.addEventListener("touchend",m),c.addEventListener("touchcancel",m);const p=document.createElement("div");p.className="touch-fire-btn",p.textContent="FIRE",t.appendChild(p),p.addEventListener("touchstart",T=>{T.preventDefault(),ci(),R.keys.MouseLeft=!0,p.classList.add("active")},{passive:!1});const y=T=>{T.preventDefault(),R.keys.MouseLeft=!1,p.classList.remove("active")};p.addEventListener("touchend",y,{passive:!1}),p.addEventListener("touchcancel",y,{passive:!1});const S=document.createElement("div");S.className="touch-lock-btn",S.textContent="LOCK",t.appendChild(S),S.addEventListener("touchstart",T=>{T.preventDefault(),ci(),Km(we),S.classList.add("active"),setTimeout(()=>S.classList.remove("active"),200)},{passive:!1});const M=document.createElement("div");M.className="touch-pause-btn",M.textContent="❚❚",t.appendChild(M),M.addEventListener("touchstart",T=>{T.preventDefault(),i()},{passive:!1})}function ep(i,e,t){return i<e?e:i>t?t:i}const Co={hint(i){return i?"Нажмите на звезду для выбора  •  Проведите для вращения  •  Щипок — масштаб":"Нажмите на звезду для выбора  •  Перетаскивайте для вращения  •  Колёсико — масштаб"},brightnessSlider(i){return`<label>Яркость</label><input type="range" min="0" max="200" value="${i}" /><span>${i}%</span>`},hud(i,e,t,n){let s=`<span class="gal-money">${i}₵</span> <span class="gal-fuel">⛽ ${e}/${t}</span>`;return n&&(s+=`<br><span class="gal-contract">Контракт → ${n}</span>`),s},infoPanel(i){let e=`<h3>${i.name}</h3>`;return i.isCurrent?(e+='<div class="gal-info-line">Вы здесь</div>',i.hasStation&&(e+='<button class="gal-btn" id="gal-station-btn">НА СТАНЦИЮ</button>'),e+='<button class="gal-btn gal-btn-explore" id="gal-explore-btn">ИССЛЕДОВАТЬ</button>'):i.isConnected?(e+=`<div class="gal-info-line">Топливо: ${i.fuelCost} ед.</div>`,i.isContractTarget&&(e+='<div class="gal-info-line gal-contract-marker">Цель контракта!</div>'),i.canTravel?e+='<button class="gal-btn" id="gal-travel-btn">ЛЕТЕТЬ</button>':e+='<div class="gal-info-line gal-no-fuel">Недостаточно топлива</div>'):e+='<div class="gal-info-line gal-no-route">Нет прямого маршрута</div>',e}};let ms=null,di=null,li=null,Rn=null,Bn=null,yu=null,Mu=null,Su=null;const tp="galaxyBrightness";function np(i){Bn=i}function BA(i,e,t){yu=i,Mu=e,Su=t}function kA(){if(ms=document.getElementById("galaxy-hud"),di=document.getElementById("galaxy-info-panel"),li||(li=document.createElement("div"),li.id="galaxy-hint",li.textContent=Co.hint(tg()),document.body.appendChild(li)),!Rn){const i=localStorage.getItem(tp),e=i!==null?parseFloat(i):1;Jf(e),Rn=document.createElement("div"),Rn.id="galaxy-brightness",Rn.innerHTML=Co.brightnessSlider(Math.round(e*100)),document.body.appendChild(Rn);const t=Rn.querySelector("input"),n=Rn.querySelector("span");t.addEventListener("input",()=>{const s=parseInt(t.value,10)/100;Jf(s),n.textContent=`${t.value}%`,localStorage.setItem(tp,String(s))})}}function Mh(){if(!ms)return;const i=ae.activeContract?jt(ae.activeContract.targetSystemId).name:void 0;ms.innerHTML=Co.hud(ae.money,ae.fuel,ae.maxFuel,i)}function zA(){if(!di)return;if(!Bn){di.style.display="none";return}const i=jt(Bn),e=Bn===ae.currentSystemId,n=jt(ae.currentSystemId).connections.includes(Bn),s=n?zE(ae.currentSystemId,Bn):0,r=n&&!e&&ae.fuel>=s,a=ae.activeContract?.targetSystemId===Bn,o=vm(Bn);di.innerHTML=Co.infoPanel({name:i.name,isCurrent:e,isConnected:n,fuelCost:s,canTravel:r,isContractTarget:!!a,hasStation:o}),di.style.display="block";const l=document.getElementById("gal-station-btn");l&&l.addEventListener("click",()=>{Mu&&Mu()});const c=document.getElementById("gal-explore-btn");c&&c.addEventListener("click",()=>{Su&&Su()});const h=document.getElementById("gal-travel-btn");if(h){const u=Bn;h.addEventListener("click",()=>{u&&fT(s)&&yu&&yu(u)})}}function HA(){di&&(di.style.display="none")}function VA(){ms&&(ms.style.display="block"),li&&(li.style.display="block"),Rn&&(Rn.style.display="flex")}function GA(){ms&&(ms.style.display="none"),di&&(di.style.display="none"),li&&(li.style.display="none"),Rn&&(Rn.style.display="none")}function ng(){Bn=null,vu(null),HA()}let Io=!1;const bu=new P,Eu=new P;let Or=0;const WA=1.5;let ho=null,ig=!1;const ip=new P;let Tu=null;function Gi(){return Io}function XA(i){Tu=i}function qA(i){const e=Qf(ae.currentSystemId),t=Qf(i);!e||!t||(bu.copy(e),Eu.copy(t),Or=0,ho=i,ig=ae.activeContract?.targetSystemId===i,Io=!0,ng(),Mh())}function YA(i){if(!Io||!ho)return;if(Or+=i/WA,Or>=1){Or=1,Io=!1,pT(ho),xh(),yh(),vh(),Mh();const n=jt(ho);UA(...n.position),Hi(),ig&&ae.activeContract?Tu&&Tu():ua();return}const e=Or,t=e<.5?2*e*e:1-Math.pow(-2*e+2,2)/2;ip.lerpVectors(bu,Eu,t),AA(ip),FA(bu,Eu,t),Hi()}let Wi=!1,Po=!1,sg=0,rg=0,Au=0,wu=0,lr=null,ag=0,og=0,Ru=0,Cu=0,lg=0,cg=0,Lo=!1;const sp=new nx,uc=new Be;function ug(i){Wi=i}function Sh(i){return i instanceof HTMLElement?!!i.closest("#galaxy-info-panel, #galaxy-hud, #galaxy-brightness"):!1}function hg(i,e){uc.x=i/window.innerWidth*2-1,uc.y=-(e/window.innerHeight)*2+1,sp.setFromCamera(uc,Ke);const t=Array.from(CA().values()),n=sp.intersectObjects(t);if(n.length>0){const s=n[0].object.userData.systemId;np(s),vu(s)}else np(null),vu(null);zA()}function dg(i){!Wi||Gi()||Sh(i.target)||i.button===0&&(Po=!0,sg=i.clientX,rg=i.clientY,Au=i.clientX,wu=i.clientY)}function fg(i){if(!(!Wi||Gi())&&Po){const e=i.clientX-Au,t=i.clientY-wu;eg(e*.005,t*.005),Au=i.clientX,wu=i.clientY,Hi()}}function pg(i){if(!(!Wi||Gi())){if(Sh(i.target)){Po=!1;return}if(i.button===0){const e=Math.abs(i.clientX-sg)>3||Math.abs(i.clientY-rg)>3;Po=!1,e||hg(i.clientX,i.clientY)}}}function mg(i){!Wi||Gi()||(i.preventDefault(),LA(i.deltaY*.05),Hi())}function gg(i){const e=i.touches[0],t=i.touches[1],n=e.clientX-t.clientX,s=e.clientY-t.clientY;return Math.sqrt(n*n+s*s)}function _g(i){if(!(!Wi||Gi())&&!Sh(i.target)){if(i.touches.length===2){Lo=!0,lr=null,lg=gg(i),cg=DA(),i.preventDefault();return}if(i.touches.length===1){const e=i.touches[0];lr=e.identifier,ag=e.clientX,og=e.clientY,Ru=e.clientX,Cu=e.clientY,i.preventDefault()}}}function xg(i){if(!(!Wi||Gi())){if(Lo&&i.touches.length>=2){i.preventDefault();const e=gg(i),t=lg/e;NA(cg*t),Hi();return}if(lr!==null)for(let e=0;e<i.changedTouches.length;e++){const t=i.changedTouches[e];if(t.identifier===lr){i.preventDefault();const n=t.clientX-Ru,s=t.clientY-Cu;eg(n*.005,s*.005),Ru=t.clientX,Cu=t.clientY,Hi()}}}}function Do(i){if(!(!Wi||Gi())){if(Lo){i.touches.length<2&&(Lo=!1);return}for(let e=0;e<i.changedTouches.length;e++){const t=i.changedTouches[e];if(t.identifier!==lr)continue;if(lr=null,Math.abs(t.clientX-ag)>8||Math.abs(t.clientY-og)>8)return;hg(t.clientX,t.clientY)}}}function KA(){window.addEventListener("mousedown",dg),window.addEventListener("mousemove",fg),window.addEventListener("mouseup",pg),window.addEventListener("wheel",mg,{passive:!1}),window.addEventListener("touchstart",_g,{passive:!1}),window.addEventListener("touchmove",xg,{passive:!1}),window.addEventListener("touchend",Do),window.addEventListener("touchcancel",Do)}function $A(){window.removeEventListener("mousedown",dg),window.removeEventListener("mousemove",fg),window.removeEventListener("mouseup",pg),window.removeEventListener("wheel",mg),window.removeEventListener("touchstart",_g),window.removeEventListener("touchmove",xg),window.removeEventListener("touchend",Do),window.removeEventListener("touchcancel",Do)}function jA(i,e,t,n=!0){kA(),ug(!0),XA(e),BA(s=>{Gi()||qA(s)},i,t),KA(),n?IA():(PA(),Hi()),yh(),vh(),Mh(),ng(),VA(),document.body.classList.add("galaxy-mode")}function ZA(){ug(!1),$A(),GA(),document.body.classList.remove("galaxy-mode")}let rp=!1;function JA(){rp||(TA(),Et.add(Wt),rp=!0)}const QA={update(i){EA(i),YA(i),MA(Ke)},enter(i){const e=i?.resetCamera!==!1,t=i?.onStation,n=i?.onCombat,s=i?.onExploration;JA(),we.visible=!1,wA(),xh(),vh(),yh(),t&&n&&s&&jA(t,n,s,e)},exit(){ZA(),RA()}},ap={update(){},enter(){},exit(){}},ew={easy:"ПРОСТОЙ",medium:"СРЕДНИЙ",hard:"СЛОЖНЫЙ"},tw={easy:"#44ff88",medium:"#ffaa44",hard:"#ff4444"},nw={page(i){let e=`
    ...
    <div class="station-body">
      ...
      <div class="station-section station-contracts-section">
        <h2>КОНТРАКТЫ</h2>
        <div class="contracts-list">`;const t=i.activeContractId!==null;for(const n of i.contracts){const s=n.id===i.activeContractId,r=tw[n.difficulty],a=ew[n.difficulty],o=i.targetNames[n.targetSystemId]??n.targetSystemId;e+=`
    ...
    <button class="station-btn station-map-btn" id="station-map-btn">НА КАРТУ</button>`,e}};let fi=null,Iu=null;function iw(i){fi=document.getElementById("station-screen"),fi&&(Iu=i,mT()&&gT(),Pu(),fi.style.display="flex")}function sw(){fi&&(fi.style.display="none")}function Pu(){if(!fi)return;const i=jt(ae.currentSystemId),e={};for(const n of co)e[n.targetSystemId]=jt(n.targetSystemId).name;fi.innerHTML=nw.page({systemName:i.name,money:ae.money,fuel:ae.fuel,maxFuel:ae.maxFuel,fuelPrice:nT,contracts:co,activeContractId:ae.activeContract?.id??null,targetNames:e}),fi.querySelectorAll(".fuel-btn").forEach(n=>{n.addEventListener("click",()=>{const s=parseInt(n.dataset.amount||"1");dT(s),Pu()})}),fi.querySelectorAll(".contract-accept-btn").forEach(n=>{n.addEventListener("click",()=>{const s=n.dataset.id,r=co.find(a=>a.id===s);r&&(cT(r),Pu())})});const t=document.getElementById("station-map-btn");t&&t.addEventListener("click",()=>{Iu&&Iu()})}const rw={update(){},enter(i){const e=i?.onBack;e&&iw(e)},exit(){sw()}};let op=!1,vg=0,os,Gs,Ws,Xs,No,yg=[],Mg=[];function Za(i,e,t){const n=new $p({antialias:!0,alpha:!0});n.setSize(i,e),n.setPixelRatio(Math.min(window.devicePixelRatio,2));const s=new Cp;s.add(new Ho(5596808,1));const r=new zo(16777215,1.5);r.position.set(5,3,2),s.add(r);const a=new $t(45,i/e,.1,500);a.position.set(0,2,t),a.lookAt(0,0,0);const o=new rn;return s.add(o),{renderer:n,scene:s,camera:a,model:o}}function Sg(i,e){i.scene.remove(i.model),i.model=e,i.scene.add(e)}function oi(i,e,t){const n=_r(on(it.colors[e]),on(it.colors[t]));Sg(i,n)}function bg(){const i=tm(0,on(it.colors.capitalHull));Sg(No,i)}function ts(i,e,t,n){const s=document.createElement("label");s.textContent=e+" ";const r=document.createElement("input");r.type="color",r.value=it.colors[t],r.addEventListener("input",()=>{it.colors[t]=r.value,n()}),r.addEventListener("change",()=>{ah()}),s.appendChild(r),i.appendChild(s),yg.push({key:t,input:r})}function hc(i,e,t,n,s,r){const a=document.createElement("div");a.className="slider-row";const o=document.createElement("label"),l=document.createElement("span");l.textContent=String(it.counts[t]),o.textContent=e+": ",o.appendChild(l);const c=document.createElement("input");c.type="range",c.min=String(n),c.max=String(s),c.step=String(r),c.value=String(it.counts[t]),c.addEventListener("input",()=>{const h=Number(c.value);it.counts[t]=h,l.textContent=String(h),ah()}),a.appendChild(o),a.appendChild(c),i.appendChild(a),Mg.push({key:t,input:c,label:l})}function Ja(i,e,t,n=!1){const s=document.createElement("div");s.className=n?"preview-card wide":"preview-card";const r=document.createElement("h3");r.textContent=e,s.appendChild(r),s.appendChild(t.renderer.domElement);const a=document.createElement("div");return a.className="color-pair",s.appendChild(a),i.appendChild(s),{card:s,colorContainer:a}}function aw(){os=document.createElement("div"),os.id="settings-screen";const i=document.createElement("h1");i.textContent="НАСТРОЙКИ",os.appendChild(i);const e=document.createElement("div");e.className="settings-content";const t=document.createElement("div");t.className="settings-section";const n=document.createElement("h2");n.textContent="ТЕХНИКА",t.appendChild(n);const s=document.createElement("div");s.className="preview-row",Gs=Za(120,120,12);const{colorContainer:r}=Ja(s,"ИГРОК",Gs);ts(r,"Корпус","playerBody",()=>oi(Gs,"playerBody","playerExhaust")),ts(r,"Двигатель","playerExhaust",()=>oi(Gs,"playerBody","playerExhaust")),Ws=Za(120,120,12);const{colorContainer:a}=Ja(s,"СОЮЗНИК",Ws);ts(a,"Корпус","allyBody",()=>oi(Ws,"allyBody","allyExhaust")),ts(a,"Двигатель","allyExhaust",()=>oi(Ws,"allyBody","allyExhaust")),Xs=Za(120,120,12);const{colorContainer:o}=Ja(s,"ПРОТИВНИК",Xs);ts(o,"Корпус","enemyBody",()=>oi(Xs,"enemyBody","enemyExhaust")),ts(o,"Двигатель","enemyExhaust",()=>oi(Xs,"enemyBody","enemyExhaust")),t.appendChild(s);const l=document.createElement("div");l.className="preview-row",l.style.marginTop="20px",No=Za(200,150,120);const{colorContainer:c}=Ja(l,"БОЕВОЙ КОРАБЛЬ",No,!0);ts(c,"Корпус","capitalHull",bg),t.appendChild(l),e.appendChild(t);const h=document.createElement("div");h.className="settings-section";const u=document.createElement("h2");u.textContent="КОЛИЧЕСТВО",h.appendChild(u),hc(h,"Боевые корабли","capitalShips",1,5,1),hc(h,"Союзники","allies",8,64,4),hc(h,"Противники","enemies",8,64,4),e.appendChild(h);const d=document.createElement("div");d.className="settings-buttons";const f=document.createElement("button");f.id="settings-reset",f.textContent="СБРОС",f.addEventListener("click",()=>{uE(),Eg(),Tg()}),d.appendChild(f);const g=document.createElement("button");g.id="settings-back",g.textContent="НАЗАД",g.addEventListener("click",()=>{lw()}),d.appendChild(g),e.appendChild(d),os.appendChild(e),document.body.appendChild(os)}function Eg(){for(const{key:i,input:e}of yg)e.value=it.colors[i];for(const{key:i,input:e,label:t}of Mg)e.value=String(it.counts[i]),t.textContent=String(it.counts[i])}function Tg(){oi(Gs,"playerBody","playerExhaust"),oi(Ws,"allyBody","allyExhaust"),oi(Xs,"enemyBody","enemyExhaust"),bg()}function Ag(){vg=requestAnimationFrame(Ag);const i=Date.now()*.001;for(const e of[Gs,Ws,Xs,No])e.model.rotation.y=i*.5,e.renderer.render(e.scene,e.camera)}function ow(){op||(aw(),op=!0),Eg(),Tg(),os.style.display="flex",document.getElementById("start-screen").style.display="none",Ag()}function lw(){cancelAnimationFrame(vg),os.style.display="none",document.getElementById("start-screen").style.display="flex"}function wg(){!R.running||vt.paused||(vt.paused=!0,ca.style.display="flex",document.exitFullscreen?.())}function cw(){vt.paused&&(document.documentElement.requestFullscreen?.(),vt.paused=!1,ca.style.display="none",uh.getDelta())}function uw(){vt.paused=!1,ca.style.display="none",gs?ET():(Si("menu"),document.getElementById("start-screen").style.display="flex")}function dc(){document.documentElement.requestFullscreen?.(),vt.paused=!1,ca.style.display="none",document.getElementById("start-screen").style.display="none",document.getElementById("game-over").style.display="none",document.getElementById("victory-screen").style.display="none",Si("combat",{combatConfig:aT})}function hw(i){document.documentElement.requestFullscreen?.(),vt.paused=!1,ca.style.display="none",Si("combat",{combatConfig:i})}function dw(){Si("menu")}yT(hw,dw);function fw(){document.getElementById("start-screen").style.display="none",Du()||Lu(),ci(),MT()}const pw=60,lp=1e3/pw;function Rg(i=0){requestAnimationFrame(Rg);const e=i-vt.lastFrameTime;if(e<lp)return;vt.lastFrameTime=i-e%lp;const t=Math.min(uh.getDelta(),.05);$E(t),Kn.render(Et,Ke)}function Qa(){const i=pu();return i==="combat"||i==="exploration"}function mw(){window.addEventListener("keydown",i=>{if(Qa()){if(i.code==="Escape"||i.code==="KeyP"){pu()==="exploration"?Pm():wg();return}R.keys[i.code]=!0,i.preventDefault()}}),window.addEventListener("keyup",i=>{Qa()&&(R.keys[i.code]=!1,i.preventDefault())}),window.addEventListener("mousemove",i=>{Qa()&&(R.mouseX=(i.clientX/window.innerWidth-.5)*2,R.mouseY=(i.clientY/window.innerHeight-.5)*2,R.mouseActive=!0)}),window.addEventListener("mousedown",i=>{Qa()&&(i.button===0&&(R.keys.MouseLeft=!0),i.button===1&&(R.running||pu()==="exploration")&&(i.preventDefault(),Km(we))),ci()}),window.addEventListener("mouseup",i=>{i.button===0&&(R.keys.MouseLeft=!1)}),window.addEventListener("keydown",()=>ci(),{once:!0}),window.addEventListener("resize",lE)}async function gw(){ks("menu",ap),ks("result",ap),ks("galaxy",QA),ks("station",rw),ks("exploration",dA),ks("combat",oA),await Qb(),vt.playerModel=_r(on(it.colors.playerBody),on(it.colors.playerExhaust)),we.add(vt.playerModel),Et.add(we),we.position.set(0,0,0),jE(),Ke.position.set(-10.5,3.75,0),Ke.lookAt(0,0,0),mw(),document.getElementById("resume-btn").addEventListener("click",cw),document.getElementById("quit-btn").addEventListener("click",uw),document.getElementById("start-btn").addEventListener("click",dc),document.getElementById("restart-btn").addEventListener("click",dc),document.getElementById("victory-restart-btn").addEventListener("click",dc),document.getElementById("campaign-btn").addEventListener("click",fw),document.getElementById("settings-btn").addEventListener("click",ow),OA(wg),uh.start(),Rg()}gw();
