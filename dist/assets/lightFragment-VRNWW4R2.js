import{S as e}from"./index-DhYPgpLm.js";import"./oitFragment-HirHBNMD.js";const i="clusteredLightingFunctions",d=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=d);const t="bumpFragmentMainFunctions",r=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=r);const o="bumpFragmentFunctions",s=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=s);const a="bumpFragment",l=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=l);const n="decalFragment",h=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=h);const f="lightFragment",g=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=g);
