import{S as e}from"./index-DhYPgpLm.js";const i="decalVertexDeclaration",I=`#ifdef DECAL
uniform vec4 vDecalInfos;uniform mat4 decalMatrix;
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=I);const t="uvAttributeDeclaration",l=`#ifdef UV{X}
attribute vec2 uv{X};
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=l);const r="prePassVertexDeclaration",u=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=u);const n="samplerVertexDeclaration",h=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
varying vec2 v_VARYINGNAME_UV;
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=h);const f="lightVxFragmentDeclaration",m=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=m);const d="lightVxUboDeclaration",A=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=A);const o="morphTargetsVertexGlobalDeclaration",R=`#ifdef MORPHTARGETS
...
#endif
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=R);const a="morphTargetsVertexDeclaration",_=`#ifdef MORPHTARGETS
...
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=_);const s="morphTargetsVertexGlobal",g=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
float vertexID;
#endif
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=g);const c="morphTargetsVertex",x=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
#if {X}==0
...
#endif
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=x);const v="prePassVertex",P=`#ifdef PREPASS_DEPTH
...
#endif
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=P);const S="uvVariableDeclaration",M=`#if !defined(UV{X}) && defined(MAINUV{X})
vec2 uv{X}=vec2(0.,0.);
#endif
#ifdef MAINUV{X}
vMainUV{X}=uv{X};
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=M);const T="samplerVertexImplementation",p=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
if (v_INFONAME_==0.)
...
#endif
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=p);const E="shadowsVertex",X=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=X);
