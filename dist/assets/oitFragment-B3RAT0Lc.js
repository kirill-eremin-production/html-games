import{S as e}from"./index-Q3kQXPCW.js";const o="decalFragmentDeclaration",h=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=h);const t="prePassDeclaration",f=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=f);const i="oitDeclaration",p=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=p);const r="lightFragmentDeclaration",u=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=u);const a="lightUboDeclaration",m=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=S);const c="shadowsFragmentFunctions",w=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=w);const l="samplerFragmentDeclaration",D=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=D);const d="reflectionFunction",E=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=E);const v="depthPrePass",g=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=g);const n="oitFragment",C=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
